...
class polygon_wiz:
    ...
    def polygon_show(self, parent, entries, fNgc, fNgcBkp, fTmp, rowS, xOrigin, yOrigin):
        ...
        entries.attach(self.dEntry, 1, 2, 8, 9)
