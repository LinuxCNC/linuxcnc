...
#        self.parent.yOrigin = self.ySEntry.get_text()
    ...
    def set_line_point_to_point(self):
        ...
        if self.add_segment > 0:
            ...
            self.entry1.set_text('{:0.3f}'.format(float(self.xOrigin)))
            self.label2.set_text('Start Y')
            self.entry2.set_text('{:0.3f}'.format(float(self.yOrigin)))
            self.label3.hide()
            self.entry3.hide()
    ...
    def set_arc_2_points_radius(self):
        ...
        if self.add_segment > 0:
            ...
            self.label8.hide()
            self.entry7.hide()
            self.entries.remove(self.g3Arc)
            self.entries.remove(self.g2Arc)
            self.entries.attach(self.g3Arc, 0, 1, 5, 6)
            self.entries.attach(self.g2Arc, 1, 2, 5, 6)
            self.g3Arc.show()
            self.g2Arc.show()
        else:
            self.entry4.grab_focus()
            ...
            self.entries.remove(self.g3Arc)
            self.entries.remove(self.g2Arc)
            self.entries.attach(self.g3Arc, 0, 1, 8, 9)
            self.entries.attach(self.g2Arc, 1, 2, 8, 9)
            self.g3Arc.show()
            self.g2Arc.show()
    ...
    def line_show(self, parent, entries, fNgc, fNgcBkp, fTmp, rowS, xOrigin, yOrigin):
        ...
        self.entries.attach(self.lType, 0, 3, 0, 1)
        self.label1 = gtk.Label()
        self.label1.set_alignment(0.95, 0.5)
        self.label1.set_width_chars(8)
        self.entries.attach(self.label1, 0, 1, 1, 2)
        ...
        self.entries.attach(self.entry1, 1, 2, 1, 2)
        self.label2 = gtk.Label()
        self.label2.set_alignment(0.95, 0.5)
        self.label2.set_width_chars(8)
        self.entries.attach(self.label2, 0, 1, 2, 3)
        ...
        self.entries.attach(self.entry2, 1, 2, 2, 3)
        self.label3 = gtk.Label()
        self.label3.set_alignment(0.95, 0.5)
        self.label3.set_width_chars(8)
        self.entries.attach(self.label3, 0, 1, 3, 4)
        ...
        self.entries.attach(self.entry3, 1, 2, 3, 4)
        self.label4 = gtk.Label()
        self.label4.set_alignment(0.95, 0.5)
        self.label4.set_width_chars(8)
        self.entries.attach(self.label4, 0, 1, 4, 5)
        ...
        self.entries.attach(self.image, 2, 5, 1, 9)
