...
""" %(os.path.join(paths.IMAGEDIR,'lcnc_swoop.png'))
    ...
    def init_pins(self):
        ...
        pin = QHAL.newpin("eoffset-value", QHAL.HAL_SINT, QHAL.HAL_IN)
        ...
        pin = QHAL.newpin("comp-count", QHAL.HAL_SINT, QHAL.HAL_IN)
        pin.value_changed.connect(self.compensate_count_changed)
        pin = QHAL.newpin("map-ready", QHAL.HAL_BOOL, Qhal.HAL_IN)
        ...
        pin = QHAL.newpin("axis-select-x", QHAL.HAL_BOOL, Qhal.HAL_IN)        
        pin = QHAL.newpin("axis-select-y", QHAL.HAL_BOOL, Qhal.HAL_IN)        
        pin = QHAL.newpin("axis-select-z", QHAL.HAL_BOOL, Qhal.HAL_IN)        
        pin = QHAL.newpin("axis-select-a", QHAL.HAL_BOOL, Qhal.HAL_IN)
        pin = QHAL.newpin("axis-select-b", QHAL.HAL_BOOL, Qhal.HAL_IN)
