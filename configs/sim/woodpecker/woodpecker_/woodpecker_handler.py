...
""" %(os.path.join(paths.IMAGEDIR,'lcnc_swoop.png'))
    ...
    def init_pins(self):
        ...
        pin.value_changed.connect(self.spindle_pwr_changed)
        pin = self.h.newpin("spindle_fault", hal.HAL_U32, hal.Dir.IN)
        pin.value_changed.connect(self.spindle_fault_changed)
        pin = self.h.newpin("modbus-errors", hal.HAL_U32, hal.Dir.IN)
       ...
       # self.h.newpin("spindle_pause", hal.Type.BOOL, hal.Dir.OUT)
        ...
        self.h.newpin("eoffset_count", hal.HAL_S32, hal.Dir.OUT)
