...
def user_hal_pins():
    ...
    comp.newpin('refresh', hal.HAL_S32, hal.Dir.IN)
    comp.newpin('material-change-number', hal.HAL_S32, hal.Dir.IN)
    comp.newpin('material-change', hal.HAL_S32, hal.Dir.IN)
    comp.newpin('material-change-timeout', hal.Type.BOOL, hal.Dir.IN)
    comp.newpin('material-reload', hal.Type.BOOL, hal.Dir.IN)
    comp.newpin('material-temp', hal.HAL_S32, hal.Dir.IN)
    comp.newpin('cut-type', hal.HAL_S32, hal.Dir.IN)
