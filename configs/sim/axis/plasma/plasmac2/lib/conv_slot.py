...
def widgets(self):
    ...
    self.lLabel.grid(column=0, row=4, pady=(4,0), sticky='e')
    self.lEntry.grid(column=1, row=4, pady=(4,0))
    self.wLabel.grid(column=0, row=5, pady=(4,0), sticky='e')
    self.wEntry.grid(column=1, row=5, pady=(4,0))
