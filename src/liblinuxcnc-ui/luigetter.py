...
../docs/man/man3/lui_%(fname)s.3lui: liblinuxcnc-ui/luigetter.py
\t$(LUIGETTER) manfile $@ %(fname)s

objects/liblinuxcnc-ui/lui_%(fname)s.cc: liblinuxcnc-ui/luigetter.py
objects/liblinuxcnc-ui/lui_%(fname)s.cc: liblinuxcnc-ui/luigetter.py
\t$(LUIGETTER) cfile $@ %(fname)s
