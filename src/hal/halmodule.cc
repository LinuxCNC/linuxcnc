...
static Py_ssize_t shm_buffer(PyObject *_self, Py_buffer *view, int flags) {
    shmobject *self = (shmobject *)_self;
    Py_INCREF(self);
    return 0;
}
...
static PyModuleDef halmoduledef = {
...
//            module_doc);
    ...
    PyObject *m;
    m = PyModule_Create(&halmoduledef);
