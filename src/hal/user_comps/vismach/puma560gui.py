...
link6 = Translate(
    [link6], 0, 0, -1.8
)  # note: 1.8 + 0.4 = 2.2 - in the drawing distance from join5 to end effector
# mount link7 on it
...
link4 = Translate(
    [link4], 0, 0, -14.25
)  # note: 14.25 + 2.8 = 17.05 - distance between j3 and j5
# assemble
link4 = Collection([link5, link4])
# move back to joint3 in origin
link4 = Translate(
    [link4], 1.85, 0, 14.25
)  # note: 14.25 as above, 1.85 = (9.2 - 5.5) / 2
link4 = Rotate([link4], -90, 1, 0, 0)
...
link2 = Translate(
    [link2], 11.2, 0, 0
)  # note: 11.2 = 4 + 7.2 (4 = distance from j1 to link2 side, 7.2 distance from j1 to j2)
...
link2 = Translate(
    [link2], 0, 0, 23.45
)  # note: 23.45 = 26.45(drawing) - 3 (from j2 to J1 in Z)
