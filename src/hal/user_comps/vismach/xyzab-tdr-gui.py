...
rot_point_set = Translate(
    [rot_point_set], machine_zero_x, machine_zero_y, machine_zero_z
)
# end tool-side
...
rotary_b = Collection(
    [
        ...
        HalTranslate(
            [Color([1, 0, 0, 1], [HalOffsetCylinderX(CylinderX)])],
            c,
            "z_offset",
            0,
            0,
...
# begin model
model = Collection([head_y, dualrotary, base, rot_point_set])
# end model
