...
class HalToolCylinder(CylinderZ):
    ...
    def coords(self):
        return (
            ...
            -tool_length_offset - self.comp["tool-length"],
            self.comp["tool-radius"],
        )
...
saddleways = Collection(
    [
        Box(
            -1.5 * saddle_way_spacing - 0.5 * saddle_way_width,
            -1.0,
            saddle_way_start,
            -1.5 * saddle_way_spacing + 0.5 * saddle_way_width,
            1.0,
        ...
        Box(
            -0.5 * saddle_way_spacing - 0.5 * saddle_way_width,
            8.0,
            saddle_way_start,
            -0.5 * saddle_way_spacing + 0.5 * saddle_way_width,
            10.0,
        ...
        # and screw
        Translate(
            [CylinderZ(saddle_way_start + 8, 1.5, saddle_way_end - 7, 1.5)], 0, 8, 0
        ),
    ]
)
...
base = Collection(
    [
        ...
        Box(
            -0.5 * saddle_way_spacing - 0.4 * saddle_way_width,
            5.0,
            saddle_way_start + 1,
            -0.5 * saddle_way_spacing + 0.8 * saddle_way_width,
            9.0,
            saddle_way_end - 1,
        ),
        Box(
        ...
        # motor
        Translate(
            [CylinderZ(saddle_way_start, 3.5, saddle_way_start - 18, 3.5)], 0, 8, 0
        ),
        # portion under column
        Box(
            (column_center_x - column_width * 1.25),
            0.0,
            saddle_way_end - 1,
            (column_center_x + column_width * 0.75),
            5.0,
            column_center_z + column_depth * 0.75,
        ),
    ]
)
...
saddle_slides = Collection(
    [
        ...
        Box(
            -1.5 * saddle_way_spacing - 0.4 * saddle_way_width,
            1.0,
            -0.5 * saddle_slide_length,
            -1.5 * saddle_way_spacing + 0.4 * saddle_way_width,
            2.5,
...
saddle = Collection(
    [
        ...
        Box(
            -1.5 * saddle_way_spacing - 0.6 * saddle_way_width,
            2.5,
            -0.5 * saddle_slide_length + 1,
            -1.5 * saddle_way_spacing + 0.6 * saddle_way_width,
            11.5,
            0.5 * saddle_slide_length - 1,
        ),
        ...
        # screw mount blocks
        Box(
            -1.5 * saddle_way_spacing + 20,
            15.0,
            -3,
            -1.5 * saddle_way_spacing + 16,
            20.5,
            3,
        ),
        Box(
            1.5 * saddle_way_spacing - 5,
            15.0,
            -3,
            1.5 * saddle_way_spacing + 5,
            20.5,
...
table_ways = Collection(
    [
        Box(
            -1.5 * saddle_way_spacing - 0.7 * saddle_way_width,
            18.0,
            -0.5 * saddle_slide_length,
            1.5 * saddle_way_spacing + 0.7 * saddle_way_width,
            20.0,
            -0.5 * saddle_slide_length + table_way_width,
        ),
        Box(
            -1.5 * saddle_way_spacing - 0.7 * saddle_way_width,
            18.0,
...
table_slides = Collection(
    [
        Box(
            -0.5 * table_length,
            -table_thick + 1.0,
            -0.5 * saddle_slide_length - 0.3 * table_way_width,
            0.5 * table_length,
            -table_thick - 1.5,
            -0.5 * saddle_slide_length + 0.9 * table_way_width,
        ),
        Box(
            -0.5 * table_length,
            -table_thick + 1.0,
        ...
        # and nut
        Translate(
            [CylinderX(-0.5 * table_length + 20, 2.2, 0.5 * table_length - 15, 2.2)],
            0,
            -table_thick - 2,
            0,
        ),
...
s = -6
table_top = table_top + [
    Box(-0.5 * table_length, -2, s * w12, 0.5 * table_length, -1, (s + 1) * w12 - 1.0),
    Box(-0.5 * table_length, -1, s * w12, 0.5 * table_length, 0, (s + 1) * w12 - 0.5),
]
s = 6
table_top = table_top + [
    Box(-0.5 * table_length, -2, (s - 1) * w12 + 1.0, 0.5 * table_length, -1, s * w12),
    Box(-0.5 * table_length, -1, (s - 1) * w12 + 0.5, 0.5 * table_length, 0, s * w12),
]
...
column = Collection(
    [
        # main body
        Box(
            column_way_top_x + 4.5,
            5.0,
            column_center_z - 0.5 * column_depth,
            column_center_x + 0.5 * column_width,
            column_height,
            column_center_z + 0.5 * column_depth,
        ),
        # way supports
        Box(
            ...
            5.0,
            column_center_z - 0.5 * column_depth,
            column_way_top_x + 1.0,
            column_height,
            column_center_z - 0.5 * column_depth + 5.0,
        ),
        Box(
            column_way_top_x + 4.5,
            5.0,
        ...
        # screw/motor mount
        Box(
            column_way_top_x + 1.5 - 2.5,
            column_height - 5.0,
            column_center_z - 3.0,
            column_way_top_x + 1.5 + 3.0,
            column_height + 1.0,
            column_center_z + 3.0,
        ),
        # motor
        Translate(
            [CylinderY(column_height + 1.0, 3.5, column_height + 19.0, 3.5)],
            column_way_top_x + 1.5,
            0,
            column_center_z,
        ),
    ]
...
column_ways = Collection(
    [
        Box(
            column_way_top_x + 2.0,
            6.0,
            column_center_z - 0.5 * column_depth - 1.0,
            column_way_top_x + 0.0,
            column_height + 0.5,
            column_center_z - 0.5 * column_depth + 4.0,
        ),
        Box(
            column_way_top_x + 2.0,
            6.0,
        ...
        # and screw
        Translate(
            [CylinderY(5.0, 1.5, column_height - 4.0, 1.5)],
            column_way_top_x + 1.5,
            0,
            column_center_z,
        ),
...
head = Collection(
    [
        ...
        Box(
            0.5 * head_width,
            head_top - 6.0,
            column_head_offset + 0.5 * column_depth - 3.0,
            column_way_top_x + 1.5 + 2.5,
            head_bottom + 6.0,
            column_head_offset + 0.5 * column_depth + 3.0,
        ),
...
head_slides = Collection(
    [
        Box(
            column_way_top_x + 1.5,
            head_top + 1.0,
            -2.5 + column_head_offset,
            0.5 * head_width,
            head_bottom - 1.0,
            3.5 + column_head_offset,
        ),
        Box(
            column_way_top_x + 1.5,
            head_top + 1.0,
            column_depth + 2.5 + column_head_offset,
            0.5 * head_width,
            head_bottom - 1.0,
            column_depth - 3.5 + column_head_offset,
        ),
        # and nut
        Translate(
            [CylinderY(head_top - 5.5, 2.2, head_bottom + 5.5, 2.2)],
            column_way_top_x + 1.5,
            0,
            column_head_offset + 0.5 * column_depth,
        ),
    ]
)
...
kins_saddle = Collection(
    [
        ...
        table_ways,
        Translate(
            [HalTranslate([kins_table], c, "table", -1, 0, 0)], 0, table_thick + 20, 0
        ),
    ]
)
...
kins_base = Collection(
    [
        ...
        saddleways,
        Translate(
            [HalTranslate([kins_head], c, "head", 0, 1, 0)],
            0,
            20 + table_thick,
            column_center_z - 0.5 * column_depth - column_head_offset,
        ),
...
x_axis = Collection(
    [CylinderX(0, 3, 30, 3), CylinderX(30, 6, 40, 0), Box(27, -6, -6, 30, 6, 6)]
)
x_axis = Color([1, 0, 0, 0], [x_axis])

y_axis = Collection(
    [CylinderY(0, 3, 30, 3), CylinderY(30, 6, 40, 0), Box(-6, 27, -6, 6, 30, 6)]
)
y_axis = Color([0, 1, 0, 0], [y_axis])

z_axis = Collection(
    [CylinderZ(0, 3, 30, 3), CylinderZ(30, 6, 40, 0), Box(-6, -6, 27, 6, 6, 30)]
)
z_axis = Color([0, 0, 1, 0], [z_axis])

axes = Collection([Box(-5, -5, -5, 5, 5, 5), x_axis, y_axis, z_axis, tooltip, work])
