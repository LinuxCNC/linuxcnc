...
net pdnt.tool.change                      whb.button.macro-1                    halui.mdi-command-01             # use MDI command from main.ini
net pdnt.G.92                             whb.button.macro-2                    halui.mdi-command-02             # use MDI command from main.ini
...
net pdnt.G.92.1                           whb.button.macro-5                    halui.mdi-command-05             # use MDI command from main.ini
net pdnt.G.92.2                           whb.button.macro-6                    halui.mdi-command-06             # use MDI command from main.ini
net pdnt.G.92.3                           whb.button.macro-7                    halui.mdi-command-07             # use MDI command from main.ini
...
# special button signals
net pdnt.button.m-home                    whb.button.m-home                     halui.home-all                   # Home all
net pdnt.button.safe-z                    whb.button.safe-z                     halui.mdi-command-03             # Park
net pdnt.button.w-home                    whb.button.w-home                     halui.mdi-command-04             # Unpark
net pdnt.button.zero-actual               whb.button.probe-z                    halui.mdi-command-08             # Probe Z=0 ou Y=0 ou X=0
...
# GUI feed rate related signals can be used when program is running and move GUI slider
