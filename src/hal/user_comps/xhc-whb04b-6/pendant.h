...
class HandwheelStepModeStepSize
{
  ...
  private:
    const float mSequence[static_cast<std::underlying_type<
        HandwheelStepModeStepSize::PositionNameIndex>::type>(
...
class HandwheelMpgModeStepSize
{
  ...
  private:
    const int8_t mSequence[static_cast<std::underlying_type<
        HandwheelMpgModeStepSize::PositionNameIndex>::type>(
        PositionNameIndex::POSITIONS_COUNT)];
};
// ----------------------------------------------------------------------
...
class HandwheelConModeStepSize
{
  ...
  private:
    const int8_t mSequence[static_cast<std::underlying_type<
        HandwheelConModeStepSize::PositionNameIndex>::type>(
        PositionNameIndex::POSITIONS_COUNT)];
};
// ----------------------------------------------------------------------
...
class HandwheelLeadModeStepSize
{
  ...
  private:
    const float mSequence[static_cast<std::underlying_type<
        HandwheelLeadModeStepSize::PositionNameIndex>::type>(
        PositionNameIndex::POSITIONS_COUNT)];
};
// ----------------------------------------------------------------------
...
class FeedRotaryButton : public RotaryButton
{
  ...
  private:
    ...
    static const std::map<const KeyCode *,
        ...
        mStepKeycodeLut;
    static const std::map<const KeyCode *,
                          HandwheelMpgModeStepSize::PositionNameIndex>
        mMpgKeycodeLut;
    static const std::map<const KeyCode *,
                          HandwheelConModeStepSize::PositionNameIndex>
        mConKeycodeLut;
    static const std::map<const KeyCode *,
...
class Display : public KeyEventListener
{
  public:
    ...
    Display(const ButtonsState &currentButtonsState,
            Hal &hal,
    ...
    virtual bool
    onButtonPressedEvent(const MetaButtonCodes &metaButton) override;
