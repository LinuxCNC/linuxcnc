...
MODULE_VERBOSE(
    emc2,
    "component:mb2hal:Userspace HAL component to communicate with one or more "
    "Modbus devices");
...
typedef struct {
    ...
    char cfg_serial_device
        [MB2HAL_MAX_DEVICE_LENGTH]; //device: example "/dev/ttyS0"
