...
typedef struct {
    ...
    hal_bit_t				*pIndexEnable;	// Setting this pin enables "clear on
							// index".  It is bidirectional, and will
							// clear itself when the index is detected
    ...
    // Private data.
    __u16				control;	// current value of control reg
} EncoderPinsParams;
