...
#define HM2_SSERIAL_MAX_DATALENGTH                                             \
    (255 + 1) // unsigned char max value plus one for buffer sizing
...
typedef struct {
    ...
    int index;
    rtapi_u32
        command_reg_addr; // a duplicate so that a single channel can be passed
...
static const hm2_sserial_data_t hm2_8i20_params[] = {
    ...
    {LBP_DATA,
     ...
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "status.current-lim",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "status.brake-on",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "status.brake-old",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "status.bus-underv",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "status.wd-reset",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "status.sw-reset",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "status.ext-reset",
     0                                                                                        },
    ...
    {LBP_DATA,
     ...
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "fault.overcurrent",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "fault.U-current",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "fault.V-current",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "fault.W-current",
     0                                                                                        },
    {LBP_DATA,
     0x01,           LBP_BOOLEAN,
     LBP_IN,                                0,
     0,                                                  0,
     "none",                                                           "fault.bus-underv",
     0                                                                                        },
...
static const hm2_sserial_data_t hm2_8i20_globals[] = {
    ...
    {LBP_DATA,
     ...
     LBP_OUT,                                     0,
     0,                                                 36,
     "volts",                                                         "nvbusundervmax",
     0                                                                                   },
    {LBP_DATA,
     0x10,           LBP_NONVOL_UNSIGNED,
     LBP_OUT,                                     0,
     0,                                                 34,
     "volts",                                                         "nvbusundervmin",
     0                                                                                   },
    {LBP_DATA,
     0x10,           LBP_NONVOL_UNSIGNED,
     LBP_OUT,                                     0,
