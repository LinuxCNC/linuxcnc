...
static const hm2_sserial_data_t hm2_7i64_params[] = {
    {0xA0,0x18,0x01,0x80,0,0,0,"none","digout"},
    {0xA0,0x18,0x01,0x00,0,0,0,"none","digin"},
    {0xA0,0x08,0x00,0x00,0,0,0,"pad","pad"},
    {0xA0,0x10,0x02,0x00,0,3.3,0,"volts","adcin.00"},
    {0xA0,0x10,0x02,0x00,0,3.3,0,"volts","adcin.01"}
};
