...
MODULE_INFO(
    linuxcnc,
    "component:hm2_7i90:LinuxCNC HAL driver for the Mesa Electronics 7i90 EPP "
...
static int ioaddr[HM2_7I90_MAX_BOARDS] = {
    0, [1 ...(HM2_7I90_MAX_BOARDS - 1)] = -1};
RTAPI_MP_ARRAY_INT(
    ioaddr,
    HM2_7I90_MAX_BOARDS,
    "base address of the parallel port(s) (see hm2_7i90(9) manpage)");

static int ioaddr_hi[HM2_7I90_MAX_BOARDS] = {[0 ...(HM2_7I90_MAX_BOARDS - 1)] =
                                                 0};
RTAPI_MP_ARRAY_INT(
    ioaddr_hi,
    HM2_7I90_MAX_BOARDS,
    "secondary address of the parallel port(s) (see hm2_7i90(9) manpage)");

static int epp_wide[HM2_7I90_MAX_BOARDS] = {[0 ...(HM2_7I90_MAX_BOARDS - 1)] =
                                                1};
RTAPI_MP_ARRAY_INT(
    epp_wide,
    HM2_7I90_MAX_BOARDS,
    "set to 0 to disable wide EPP mode (see (hm2_7i90(9) manpage)");
...
RTAPI_MP_ARRAY_STRING(
    config,
    HM2_7I90_MAX_BOARDS,
    "config string(s) for the 7i90 board(s) (see hostmot2(9) manpage)");
...
static inline void hm2_7i90_epp_write_status(uint8_t status_byte,
                                             hm2_7i90_t *board)
{
...
static inline void hm2_7i90_epp_write_control(uint8_t control_byte,
                                              hm2_7i90_t *board)
{
...
int hm2_7i90_read(hm2_lowlevel_io_t *this,
                  rtapi_u32 addr,
                  void *buffer,
                  int size)
{
...
int hm2_7i90_write(hm2_lowlevel_io_t *this,
                   rtapi_u32 addr,
                   const void *buffer,
                   int size)
{
        ...
        if (board[i].port.base_hi) {
            rtapi_outb(
                ...
                board[i].port.base_hi +
                    HM2_7I90_ECP_CONTROL_HIGH_OFFSET); // select EPP mode in ECR
        }
