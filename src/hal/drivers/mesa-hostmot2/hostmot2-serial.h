...
#define HM2_PKTUART_TXMODE_NFRAMES_MASK                                        \
    (0x1fu << HM2_PKTUART_TXMODE_NFRAMES_BIT)
#define HM2_PKTUART_TXMODE_NFRAMES(x)                                          \
    (((x) & 0x1fu) << HM2_PKTUART_TXMODE_NFRAMES_BIT)
#define HM2_PKTUART_TXMODE_NFRAMES_VAL(x)                                      \
    (((x) >> HM2_PKTUART_TXMODE_NFRAMES_BIT) & 0x1fu)
...
#define HM2_PKTUART_TXMODE_INTERFRAMEDLY_MASK                                  \
    (0xffu << HM2_PKTUART_TXMODE_INTERFRAMEDLY_BIT)
#define HM2_PKTUART_TXMODE_INTERFRAMEDLY(x)                                    \
    (((x) & 0xffu) << HM2_PKTUART_TXMODE_INTERFRAMEDLY_BIT)
#define HM2_PKTUART_TXMODE_INTERFRAMEDLY_VAL(x)                                \
    (((x) >> HM2_PKTUART_TXMODE_INTERFRAMEDLY_BIT) & 0xffu)
...
#define HM2_PKTUART_TXMODE_ERRORSCFIFO                                         \
    (1u << HM2_PKTUART_TXMODE_ERRORSCFIFO_BIT)
#define HM2_PKTUART_TXMODE_DRIVEENDLY_MASK                                     \
    (0xfu << HM2_PKTUART_TXMODE_DRIVEENDLY_BIT)
#define HM2_PKTUART_TXMODE_DRIVEENDLY(x)                                       \
    (((x) & 0xfu) << HM2_PKTUART_TXMODE_DRIVEENDLY_BIT)
#define HM2_PKTUART_TXMODE_DRIVEENDLY_VAL(x)                                   \
    (((x) >> HM2_PKTUART_TXMODE_DRIVEENDLY_BIT) & 0xfu)
...
#define HM2_PKTUART_RXMODE_ERRORBADPOP                                         \
    (1u << HM2_PKTUART_RXMODE_ERRORBADPOP_BIT)
#define HM2_PKTUART_RXMODE_RXFILTER_MASK                                       \
    (0xffu << HM2_PKTUART_RXMODE_RXFILTER_BIT)
#define HM2_PKTUART_RXMODE_RXFILTER(x)                                         \
    (((x) & 0xffu) << HM2_PKTUART_RXMODE_RXFILTER_BIT)
#define HM2_PKTUART_RXMODE_RXFILTER_VAL(x)                                     \
    (((x) >> HM2_PKTUART_RXMODE_RXFILTER_BIT) & 0xffu)
...
#define HM2_PKTUART_RXMODE_NFRAMES_MASK                                        \
    (0x1fu << HM2_PKTUART_RXMODE_NFRAMES_BIT)
#define HM2_PKTUART_RXMODE_NFRAMES(x)                                          \
    (((x) & 0x1fu) << HM2_PKTUART_RXMODE_NFRAMES_BIT)
#define HM2_PKTUART_RXMODE_NFRAMES_VAL(x)                                      \
    (((x) >> HM2_PKTUART_RXMODE_NFRAMES_BIT) & 0x1fu)
...
#define HM2_PKTUART_RXMODE_INTERFRAMEDLY_MASK                                  \
    (0xffu << HM2_PKTUART_RXMODE_INTERFRAMEDLY_BIT)
#define HM2_PKTUART_RXMODE_INTERFRAMEDLY(x)                                    \
    (((x) & 0xffu) << HM2_PKTUART_RXMODE_INTERFRAMEDLY_BIT)
#define HM2_PKTUART_RXMODE_INTERFRAMEDLY_VAL(x)                                \
    (((x) >> HM2_PKTUART_RXMODE_INTERFRAMEDLY_BIT) & 0xffu)
...
#define HM2_PKTUART_RXMODE_ERRORPARITY                                         \
    (1u << HM2_PKTUART_RXMODE_ERRORPARITY_BIT)
#define HM2_PKTUART_RXMODE_ERRORRCFIFO                                         \
    (1u << HM2_PKTUART_RXMODE_ERRORRCFIFO_BIT)
...
#define HM2_PKTUART_RXMODE_ERROROVERRUN                                        \
    (1u << HM2_PKTUART_RXMODE_ERROROVERRUN_BIT)
#define HM2_PKTUART_RXMODE_ERRORSTARTBIT                                       \
    (1u << HM2_PKTUART_RXMODE_ERRORSTARTBIT_BIT)
...
#define HM2_PKTUART_RCR_ICHARBITS_BIT                                          \
    24 // bits 24..31 Max inter-character bit-times (V3+ only)
...
#define HM2_PKTUART_RCR_ICHARBITS(x)                                           \
    (((x) & 0xffu) << HM2_PKTUART_RCR_ICHARBITS_BIT)
#define HM2_PKTUART_RCR_ICHARBITS_VAL(x)                                       \
    (((x) >> HM2_PKTUART_RCR_ICHARBITS_BIT) & 0xffu)
...
#define HM2_PKTUART_RCR_NBYTES_VAL(x)                                          \
    (((x) >> HM2_PKTUART_RCR_NBYTES_BIT) & 0x3ffu)
...
typedef struct {
    ...
    rtapi_u32
        ifdelay; // RX+TX: Inter-frame delay in bit times ([0..255] or V3+ [0..1020])
...
#define HM2_PKTUART_CONFIG_DRIVEAUTO                                           \
    0x0002                             // TX-only Output drive auto-on on send
#define HM2_PKTUART_CONFIG_RXEN 0x0010 // RX-only Receiver enable
#define HM2_PKTUART_CONFIG_RXMASKEN                                            \
    0x0020 // RX-only Receiver masked when sending (half-duplex)
#define HM2_PKTUART_CONFIG_PARITYEN 0x0100 // RX+TX Parity enable
#define HM2_PKTUART_CONFIG_PARITYODD                                           \
    0x0200 // RX+TX Parity Odd (even when unset and parity enabled)
#define HM2_PKTUART_CONFIG_STOPBITS2 0x0400 // RX+TX Set two stopbits (V3+)
#define HM2_PKTUART_CONFIG_FLUSH                                               \
    0x4000 // RX+TX flag (flush fifo and count regs)
#define HM2_PKTUART_CONFIG_FORCECONFIG                                         \
    0x8000 // RX+TX Always write the config to the board, even when not changed
...
int hm2_pktuart_setup(const char *name,
                      ...
                      rtapi_s32 rx_mode,
                      int txclear,
                      int rxclear) __attribute__((deprecated));
int hm2_pktuart_setup_rx(const char *name,
                         ...
                         int frame_delay,
                         bool rx_enable,
                         bool rx_mask) __attribute__((deprecated));
int hm2_pktuart_setup_tx(const char *name,
                         ...
                         bool drive_enable,
                         bool drive_auto,
                         int enable_delay) __attribute__((deprecated));
