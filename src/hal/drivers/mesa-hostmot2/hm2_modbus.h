...
#define MBCCB_FORMAT_SUSPEND_BIT                                               \
    4 // bit  4 Set if state-machine starts suspended
...
#define MBCCB_CMDF_WFLUSH                                                      \
    0x0010 // Don't write initial pin values but flush the output
#define MBCCB_CMDF_DISABLED                                                    \
    0x0020 // Start this command in disabled mode and must be reset
