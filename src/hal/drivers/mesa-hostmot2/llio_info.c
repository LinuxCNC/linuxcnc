...
static const char *hm2_7c81_pin_names[] = {
    "P1-01/DB25-01", "P1-02/DB25-14", "P1-03/DB25-02", "P1-04/DB25-15",
    "P1-05/DB25-03", "P1-06/DB25-16", "P1-07/DB25-04", "P1-08/DB25-17",
    "P1-09/DB25-05", "P1-11/DB25-06", "P1-13/DB25-07", "P1-15/DB25-08",
    "P1-17/DB25-09", "P1-19/DB25-10", "P1-21/DB25-11", "P1-23/DB25-12",
    "P1-25/DB25-13", "J5-TX0",        "J6-TX1",

    "P2-01/DB25-01", "P2-02/DB25-14", "P2-03/DB25-02", "P2-04/DB25-15",
    "P2-05/DB25-03", "P2-06/DB25-16", "P2-07/DB25-04", "P2-08/DB25-17",
    "P2-09/DB25-05", "P2-11/DB25-06", "P2-13/DB25-07", "P2-15/DB25-08",
    "P2-17/DB25-09", "P2-19/DB25-10", "P2-21/DB25-11", "P2-23/DB25-12",
    "P2-25/DB25-13", "J5-TXEN0",      "J6-TXEN1",

    "P7-01/DB25-01", "P7-02/DB25-14", "P7-03/DB25-02", "P7-04/DB25-15",
    "P7-05/DB25-03", "P7-06/DB25-16", "P7-07/DB25-04", "P7-08/DB25-17",
    "P7-09/DB25-05", "P7-11/DB25-06", "P7-13/DB25-07", "P7-15/DB25-08",
    "P7-17/DB25-09", "P7-19/DB25-10", "P7-21/DB25-11", "P7-23/DB25-12",
    "P7-25/DB25-13", "P5-RX0",        "P6-RX1"};
...
static const info_entry_t spiboards[] = {
    {
     ...
     .ioport_connector_name = {"Embedded I/O",
                                  "Embedded I/O + P1 expansion"},
...
const char *set_llio_info_spi(hm2_lowlevel_io_t *llio, const hm2_idrom_t *idrom)
{
    ...
    for (unsigned i = 0; i < NELEM(spiboards); i++) {
        if (!memcmp(idrom->board_name,
                    spiboards[i].board_name,
            ...
            for (unsigned j = 0; j < ANYIO_MAX_IOPORT_CONNECTORS; j++)
                llio->ioport_connector_name[j] =
                    spiboards[i].ioport_connector_name[j];
    ...
    rtapi_print_msg(RTAPI_MSG_ERR,
                    "set_llio_info_spi(): Unknown hostmot2 board name: %.8s\n",
                    buf);
    return NULL;
}
