...
MODULE_DESCRIPTION(
    "Driver for HostMot2 on the 7i80 Anything I/O board from Mesa Electronics");
#ifdef MODULE_SUPPORTED_DEVICE
MODULE_SUPPORTED_DEVICE("Mesa-AnythingIO-7i80");
#endif

static char *board_ip[MAX_ETH_BOARDS];
RTAPI_MP_ARRAY_STRING(board_ip,
                      MAX_ETH_BOARDS,
                      "ip address of ethernet board(s)");
...
static const char *hm2_7i96_pin_names[] = {
    "TB3-01",        "TB3-02",        "TB3-03",        "TB3-04",
    "TB3-05",        "TB3-06",        "TB3-07",        "TB3-08",
    "TB3-09",        "TB3-10",        "TB3-11",        "TB3-13/TB3-14",
    "TB3-15/TB3-16", "TB3-17/TB3-18", "TB3-19/TB3-20", "TB3-21/TB3-22",
    "TB3-23/TB3-24",

    "TB1-02/TB1-03", "TB1-04/TB1-05", "TB1-08/TB1-09", "TB1-10/TB1-11",
    "TB1-14/TB1-15", "TB1-16/TB1-17", "TB1-20/TB1-21", "TB1-22-TB1-23",

    "TB2-02/TB2-03", "TB2-04/TB2-05", "TB2-07/TB2-08", "TB2-10/TB2-11",
    "TB2-13/TB2-14", "TB2-16/TB2-17", "TB2-18/TB2-19",
...
static const char *hm2_7i94_pin_names[] = {
    ...
    "P2-02/DB25-14", "P2-03/DB25-02", "P2-04/DB25-15", "P2-05/DB25-03",
    "P2-06/DB25-16", "P2-07/DB25-04", "P2-08/DB25-17", "P2-09/DB25-05",
    "P2-11/DB25-06", "P2-13/DB25-07", "P2-15/DB25-08", "P2-17/DB25-09",
    "P2-19/DB25-10", "P2-21/DB25-11", "P2-23/DB25-12", "P2-25/DB25-13",
    "J6-RX0",        "J6-TX0",        "J6-TXEN0",      "J7-RX1",

    "J7-TX1",        "J7-TXEN1",      "J8-RX2",        "J8-TX2",
    "J8-TXEN2",      "J9-RX3",        "J9-TX3",        "J9-TXEN3",
    "J4-RX4",        "J4-TX4",        "J4-TXEN4",      "J3-RX5",
    "J3-TX5",        "J3-TXEN5",      "J2-RX6",        "J2-TX6",
    "J2-TXEN6",      "J1-RX7",        "J1-TX7",        "J1-TXEN7",
    "P2-/IOENA"};

static const char *hm2_7i95_pin_names[] = {
    "TB3-02/TB3-03", /* Step/Dir/Misc 5V out */
    "TB3-04/TB3-05",      "TB3-08/TB3-09",
    "TB3-10/TB3-11",      "TB3-14/TB3-15",
    "TB3-16/TB3-17",      "TB3-20/TB3-21",
    "TB3-22/TB3-23",      "TB4-02/TB4-03",
    "TB4-04/TB4-05",      "TB4-08/TB4-09",
    "TB4-10/TB4-11",      "TB4-14/TB4-15", /* RS-422/RS-485 interface */
    "TB4-16/TB4-17",      "TB3-16/TB3-17",
    "TB4-20/TB4-21",      "TB4-22/TB4-23",
    "TB4-22/TB4-23",      "TB1-01/TB1-09", /* Muxed encoders */
    "TB1-04/TB1-12",      "TB1-07/TB1-15",
    "TB1-17/TB2-01",      "TB1-20/TB2-04",
    "TB1-23/TB2-07",      "TB2-09/TB2-17",
    "TB2-12/TB2-20",      "TB2-15/TB2-23",
    "Internal EncMux",    "Internal InMux0", /* InMux */
    "Internal InMux1",    "Internal InMux2",
    "Internal InMux3",    "Internal InMux4",
    "Internal InMuxData", "TB5-13/TB5-14", /* SSR */
    "TB5-15/TB5-16",      "TB5-17/TB5-18",
    "TB5-19/TB5-20",      "TB5-21/TB5-22",
    "TB5-23/TB5-24",      "internal",

    "P1-01/DB25-01", /* P1 parallel expansion */
    "P1-02/DB25-14",      "P1-03/DB25-02",
    "P1-04/DB25-15",      "P1-05/DB25-03",
    "P1-06/DB25-16",      "P1-07/DB25-04",
    "P1-08/DB25-17",      "P1-09/DB25-05",
    "P1-11/DB25-06",      "P1-13/DB25-07",
    "P1-15/DB25-08",      "P1-17/DB25-09",
    "P1-19/DB25-10",      "P1-21/DB25-11",
    "P1-23/DB25-12",      "P1-25/DB25-13",
};
...
static const char *hm2_7i97_pin_names[] = {
    ...
    "TB2-12/TB2-20",   "TB2-15/TB2-23",
    "Internal EncMux", "TB5-13/TB5-14", /* SSR */
    "TB5-15/TB5-16",   "TB5-17/TB5-18",
    "TB5-19/TB5-20",   "TB5-21/TB5-22",
    "TB5-23/TB5-24",   "Internal InMux0", /* InMux */
    "Internal InMux1", "Internal InMux2",
    "Internal InMux3", "Internal InMuxData",
...
static bool use_iptables()
{
    if (iptables_state == -1) {
        ...
        int res = shell(IPTABLES
                        "-C OUTPUT -j " CHAIN
                        " 2>/dev/null || /sbin/iptables -I OUTPUT 1 -j " CHAIN);
        if (res != EXIT_SUCCESS) {
...
static int install_iptables_perinterface(const char *ifbuf)
{
    ...
    res = install_iptables_rule(
        "-o %s -j REJECT --reject-with icmp-admin-prohibited", ifbuf);
    if (res < 0)
        return res;

    res = eshellf(HM2_LLIO_NAME,
                  "/sbin/sysctl -q net.ipv6.conf.%s.disable_ipv6=1",
                  ifbuf);
    if (res < 0)
        return res;
...
static int fetch_hwaddr(const char *board_ip, int sockfd, unsigned char buf[6])
{
    ...
    LL_PRINT(
        "%s: INFO: Hardware address (MAC): %02x:%02x:%02x:%02x:%02x:%02x\n",
        board_ip,
        buf[0],
        buf[1],
        buf[2],
...
static int init_board(hm2_eth_t *board, const char *board_ip)
{
    ...
    ret = connect(board->sockfd,
                  (struct sockaddr *)&board->server_addr,
    ...
    if (!use_iptables()) {
        LL_PRINT(
            ...
            "This means that other software using the same network interface "
            "can violate\n"
    ...
    ret = fetch_hwaddr(
        board_ip, board->sockfd, (void *)&board->req.arp_ha.sa_data);
    if (ret < 0) {
...
static int
eth_socket_recv_loop(int sockfd, void *buffer, int len, int flags, long timeout)
{
...
static int
hm2_eth_read(hm2_lowlevel_io_t *this, rtapi_u32 addr, void *buffer, int size)
{
    ...
    if (rtapi_task_self() >= 0) {
        ...
        if (!printed) {
            LL_PRINT("ERROR: used llio->read in realtime task (addr=0x%04x)\n",
                     addr);
            LL_PRINT("This causes additional network packets which hurts "
                     "performance\n");
            printed = true;
        }
    }
    ...
    LBP16_INIT_PACKET4(
        read_packet, CMD_READ_HOSTMOT2_ADDR32_INCR(size / 4), addr & 0xFFFF);

    send = eth_socket_send(
        board->sockfd, (void *)&read_packet, sizeof(read_packet), 0);
    if (send < 0)
        LL_PRINT("ERROR: sending packet: %s\n", strerror(errno));
    LL_PRINT_IF(
        debug,
        "read(%d) : PACKET SENT [CMD:%02X%02X | ADDR: %02X%02X | SIZE: %d]\n",
        board->read_cnt,
        read_packet.cmd_hi,
        read_packet.cmd_lo,
        read_packet.addr_lo,
    ...
    if (recv == 4) {
        LL_PRINT_IF(
            debug,
            "read(%d) : PACKET RECV [DATA: %08X | SIZE: %d | TRIES: %d | TIME: "
            "%llu]\n",
            board->read_cnt,
            *tmp_buffer,
            recv,
        ...
        LL_PRINT_IF(
            debug,
            "read(%d) : PACKET RECV [SIZE: %d | TRIES: %d | TIME: %llu]\n",
            board->read_cnt,
            recv,
            i,
            t2 - t1);
...
static int hm2_eth_send_queued_reads(hm2_lowlevel_io_t *this)
{
    ...
    LBP16_INIT_PACKET4(*(lbp16_cmd_addr *)(board->read_packet_ptr),
                       CMD_READ_COMM_CTRL_ADDR16(1),
                       0x8);
    ...
    *(uint32_t *)board->read_packet_ptr = board->read_cnt;
    ...
    LBP16_INIT_PACKET4(*(lbp16_cmd_addr *)(board->read_packet_ptr),
                       CMD_READ_TIMER_ADDR16_INCR(4),
                       0x10);
    board->read_packet_ptr += sizeof(lbp16_cmd_addr);
    board->queue_reads[board->queue_reads_count].buffer =
        &board->confirm_read_cnt;
    board->queue_reads[board->queue_reads_count].size = 8;
    board->queue_reads[board->queue_reads_count].from = board->queue_buff_size;
    board->queue_reads_count++;
    board->queue_buff_size += 8;

    send = eth_socket_send(board->sockfd,
                           (void *)&board->read_packet,
                           board->read_packet_ptr - board->read_packet,
                           0);
    if (send < 0) {
        LL_PRINT("ERROR: sending packet: %s\n", strerror(errno));
...
static int hm2_eth_receive_queued_reads(hm2_lowlevel_io_t *this)
{
    ...
    if (read_timeout <=
        0) //less than or equal to 0, use 80% of the thread period.
        read_timeout = 80;
    if (read_timeout <
        100) //less than 100 is interpreted as a percentage of the thread period.
        read_timeout = rtapi_div_s64(
            read_timeout * (unsigned long long)board->llio.period, 100);
    ...
    do_recv_packet:
        errno = 0;
        recv = eth_socket_recv(board->sockfd,
                               (void *)&tmp_buffer,
                               board->queue_buff_size,
                               MSG_DONTWAIT);
        if (recv < 0)
            rtapi_delay(READ_PCK_DELAY_NS);
        t2 = rtapi_get_time();
    ...
    LL_PRINT_IF(
        debug,
        "enqueue_read(%d) : PACKET RECV [SIZE: %d | TRIES: %d | TIME: %llu]\n",
        board->read_cnt,
        recv,
        i,
        t2 - t1);
    ...
    for (i = 0; i < board->queue_reads_count; i++) {
        memcpy(board->queue_reads[i].buffer,
               &tmp_buffer[board->queue_reads[i].from],
               board->queue_reads[i].size);
    }
...
static int hm2_eth_reset(hm2_lowlevel_io_t *this)
{
    ...
    LBP16_INIT_PACKET8(bite_packet,
                       CMD_WRITE_HOSTMOT2_ADDR32_INCR(1),
                       HM2_ADDR_WATCHDOG,
                       0x0001);
    int ret = eth_socket_send(
        board->sockfd, (void *)&bite_packet, sizeof(bite_packet), 0);
    if (ret < 0)
        perror("eth_socket_send(bite_packet)");
    return ret < 0 ? -errno : 0;
}

static int hm2_eth_enqueue_read(hm2_lowlevel_io_t *this,
                                rtapi_u32 addr,
                                void *buffer,
                                int size)
{
    ...
    LBP16_INIT_PACKET4(*(lbp16_cmd_addr *)board->read_packet_ptr,
                       CMD_READ_HOSTMOT2_ADDR32_INCR(size / 4),
                       addr);
    board->read_packet_ptr += sizeof(lbp16_cmd_addr);
...
static int hm2_eth_enqueue_write(hm2_lowlevel_io_t *this,
                                 rtapi_u32 addr,
                                 const void *buffer,
                                 int size);

static int hm2_eth_write(hm2_lowlevel_io_t *this,
                         rtapi_u32 addr,
                         const void *buffer,
                         int size)
{
    ...
    LBP16_INIT_PACKET4(packet.wr_packet,
                       CMD_WRITE_HOSTMOT2_ADDR32_INCR(size / 4),
                       addr & 0xFFFF);

    send = eth_socket_send(
        board->sockfd, (void *)&packet, sizeof(lbp16_cmd_addr) + size, 0);
    if (send < 0)
        LL_PRINT("ERROR: sending packet: %s\n", strerror(errno));
    LL_PRINT_IF(
        debug,
        "write(%d): PACKET SENT [CMD:%02X%02X | ADDR: %02X%02X | SIZE: %d]\n",
        board->write_cnt,
        packet.wr_packet.cmd_hi,
        packet.wr_packet.cmd_lo,
        packet.wr_packet.addr_lo,
        packet.wr_packet.addr_hi,
        size);
...
static int hm2_eth_send_queued_writes(hm2_lowlevel_io_t *this)
{
    ...
    t0 = rtapi_get_time();
    send = eth_socket_send(board->sockfd,
                           (void *)&board->write_packet,
                           board->write_packet_size,
                           0);
    if (send < 0) {
        LL_PRINT("ERROR: sending packet: %s\n", strerror(errno));
        return 0;
    ...
    t1 = rtapi_get_time();
    LL_PRINT_IF(debug,
                "enqueue_write(%d) : PACKET SEND [SIZE: %d | TIME: %llu]\n",
                board->write_cnt,
                send,
                t1 - t0);
    board->write_packet_ptr = board->write_packet;
                                 ...
                                 int size)
{
    ...
    // XXX this is missing a check for exceeding the maximum packet size!
    LBP16_INIT_PACKET4_PTR(
        packet, CMD_WRITE_HOSTMOT2_ADDR32_INCR(size / 4), addr);
    board->write_packet_ptr += sizeof(*packet);
...
static int hm2_eth_probe(hm2_eth_t *board)
{
    ...
    recv = eth_socket_recv_loop(
        board->sockfd, (void *)&board_name, 16, 0, 200 * 1000 * 1000);
    if (recv < 0) {
    ...
    if (strncmp(board_name, "7I80DB-16", 9) == 0) {
        ...
        LL_PRINT(
            "Unrecognized ethernet board found: %.16s -- port names will be "
            "wrong\n",
            board_name);
        memcpy(llio_name, board_name, 4);
...
int rtapi_app_main(void)
{
    ...
    LL_PRINT(
        "loading Mesa AnyIO HostMot2 ethernet driver version " HM2_ETH_VERSION
        "\n");
    ...
    for (i = 0, ret = 0;
         ret == 0 && i < MAX_ETH_BOARDS && board_ip[i] && *board_ip[i];
         i++) {
