...
typedef struct {
    ...
    struct {
        ...
        struct {
            hal_s64_t *rawcounts;       // raw encoder counts
            hal_s64_t *rawlatch;        // raw encoder of latch
            hal_s64_t *count;           // (rawcounts - zero_offset)
            hal_s64_t *count_latch;     // (rawlatch - zero_offset)
    ...
    rtapi_s64 zero_offset;     // *hal.pin.counts == (*hal.pin.rawcounts - zero_offset)
