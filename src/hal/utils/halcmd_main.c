...
static void print_help_general(int showR)
{
    ...
    printf(
        "                 is to exit if any command fails. (Useful with -f)\n");
    ...
    printf("commands:\n\n");
    printf("  loadrt, loadusr, waitusr, unload, unloadrt, unloadusr, lock, "
           "unlock, net, linkpp, linkps, linksp,\n");
    printf(
        "  unlinkp, alias, unalias, newsig, delsig, setp, getp, ptype, sets, "
        "gets, stype, addf, delf,\n");
    printf(
        "  show, list, save, status, start, stop, source, echo, unecho, quit, "
        "exit, debug, print\n");
