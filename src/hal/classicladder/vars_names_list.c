...
StrConvIdVarName TableConvIdVarName[] = {
    ...
    {"T%d.V",
     ...
     FALSE                                                                    },
    {"M%d.R",
     VAR_MONOSTABLE_RUNNING, 0,
     /*sizes*/ NBR_MONOSTABLES_DEF,
     -1,
     -1,
     /*offsets */ 0,
     0,                                                               0,
    ...
    {"C%d.V",
     ...
     TRUE /*FALSE*/                                                           },
    {"TM%d.Q",
     VAR_TIMER_IEC_DONE,     0,
     /*sizes*/ NBR_TIMERS_IEC_DEF,
     -1,
     -1,
     /*offsets */ 0,
     0,                                                               0,
...
#endif
    {"IW%d",
     VAR_PHYS_WORD_INPUT,    0,
     /*sizes*/ NBR_PHYS_WORDS_INPUTS_DEF,
     -1,
     -1,
     /*offsets */ 0,
     0,                                                               0,
     FALSE                                                                    },
    {"QW%d",
     VAR_PHYS_WORD_OUTPUT,   0,
     /*sizes*/ NBR_PHYS_WORDS_OUTPUTS_DEF,
     -1,
     -1,
     /*offsets */ 0,
     0,                                                               0,
     TRUE                                                                     },
    {"IF%d",
     VAR_PHYS_FLOAT_INPUT,   0,
     /*sizes*/ NBR_PHYS_FLOAT_INPUTS_DEF,
     -1,
     -1,
     /*offsets */ 0,
     0,                                                               0,
     FALSE                                                                    },
    {"QF%d",
     VAR_PHYS_FLOAT_OUTPUT,  0,
     /*sizes*/ NBR_PHYS_FLOAT_OUTPUTS_DEF,
     -1,
     -1,
     /*offsets */ 0,
     0,                                                               0,
