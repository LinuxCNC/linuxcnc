...
#define gtk_signal_connect(instance, detailed_signal, c_handler, data)         \
    g_signal_connect(instance, detailed_signal, c_handler, data)
#define gtk_signal_disconnect(instance, handler_id)                            \
...
void GetCurrentNumAndNbrRungsForCurrentSection(int *NumCurrentRung,
                                               int *NbrRungs);
#endif
