...
/*
  $Log: gomath.c,v $
  Revision 1.43  2009/05/19 18:00:34  proctor
  Added go_point_plane_project, go_point_line_project,
  go_line_plane_project, go_cart_cart_par,perp

  Revision 1.42  2009/02/18 18:56:15  proctor
  Added 3x3, 4x4 matrix functions optimized with explicit symbolic terms

  Revision 1.41  2008/10/07 16:57:10  proctor
  Added go_cart_cart_rot

  Revision 1.40  2008/09/23 19:35:42  proctor
  Initialized imax to zero

  Revision 1.39  2008/01/18 21:50:11  proctor
  Added API comments to gomath; added options to gomathtest for interactive
  tests

  Revision 1.38  2008/01/16 21:45:07  proctor
  Fixed circular motion to use arc length as interpolation, so that stopping
  works. It still effectively interpolates via the angle, so that points far
  out on the spiral are spaced farther apart.

  Revision 1.37  2008/01/11 13:40:16  proctor
  Added go_pose_scale_mult to gomath; improved igpsserver and igpsclient
  with some more options for printing debug information, using forward
  kinematics; added WALK_IN_SCALE compile-time def to slow down the speed
  at which xinv is walked in

  Revision 1.36  2007/12/17 21:51:37  proctor
  Fixed go_pose_screw_mult call in trajloop to use the proper transformation

  Revision 1.35  2007/12/13 19:18:35  proctor
  Added tool transform in/out, but didn't handle it kinematically yet

  Revision 1.34  2007/12/11 18:42:44  proctor
  Added go_cart_magsq

  Revision 1.33  2007/10/03 20:54:42  proctor
  Added go_line_from_planes

  Revision 1.32  2007/10/03 12:44:54  proctor
  Cleaned up some calls to go_cart_unit whose return values weren't inspected

  Revision 1.31  2007/10/02 14:26:41  proctor
  Added go_line,plane functions

  Revision 1.30  2007/05/18 17:24:01  proctor
  Fixed problems with uninitialized starting joints, use of joint increments
  instead of base plus increments

  Revision 1.29  2007/05/14 14:08:25  proctor
  Fixed bug in inverse kins where success copy-out loop was terminated
  after first joint; added set, get max iteration functions

  Revision 1.28  2007/05/11 20:50:41  proctor
  Took out the 's' element of a go_rvec, and made a go_rvec simply an xyz
  vector. Took out go_uvec entirely. Worked on the iterative inverse kins
  in genserkins, which don't converge yet.

  Revision 1.27  2007/05/10 18:32:32  proctor
  Added genserkins and changed the args to get,set_parameters to include
  the number of joints

  Revision 1.26  2007/05/08 21:10:20  proctor
  ...
  Revision 1.21  2007/04/24 23:10:07  proctor
  Used new go_matrix structure

  Revision 1.20  2007/04/24 15:19:51  proctor
  Added general matrix functions

  Revision 1.19  2007/01/09 19:17:47  proctor
  Made go_pose_pose_mult safe for same input as output, tested with trajloop

  Revision 1.18  2006/12/22 13:48:57  proctor
  ...
  Revision 1.17  2006/11/22 15:36:15  proctor
  Fixed sqrt check on mat to quat convert, to fix problems in puma kins

  Revision 1.16  2006/11/21 15:25:59  proctor
  Added world jog command via inv jac

  Revision 1.15  2006/11/20 18:22:15  proctor
  Tested matrix decls, and reverted back

  Revision 1.14  2006/11/20 17:39:28  proctor
  Took out RC matrix index macro in place of [][] notation

  Revision 1.13  2006/11/16 18:48:23  proctor
  Fixed unix rtapi_arg bug with string malloc

  Revision 1.12  2006/11/08 21:28:25  proctor
  ...
  Revision 1.11  2006/10/31 21:19:07  proctor
  Completed go_pose_cart_mult, adding go_tridiag functions

  Revision 1.10  2006/10/10 14:24:35  proctor
  ...
  Revision 1.9  2006/10/07 19:38:05  proctor
  Put go_cbrt in gomath.c,h, took out of gotraj.c

  Revision 1.8  2006/09/28 19:11:08  proctor
  More tweaks on cubic solver

  Revision 1.7  2006/09/20 19:55:41  proctor
