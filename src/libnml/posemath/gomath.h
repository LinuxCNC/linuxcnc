...
/*! Convenience function that returns a \a go_pose given individual
  elements. */
extern go_pose go_pose_this(go_real x,
                            go_real y,
                            go_real z,
                            go_real rs,
                            go_real rx,
...
extern go_cart go_cart_zero(void);

/*! Returns the identity (zero) quaternion, i.e., no rotation. */
extern go_quat go_quat_identity(void);

/*! Returns the identity pose, no translation or rotation. */
extern go_pose go_pose_identity(void);
...
extern int go_line_from_point_direction(const go_cart *point,
...
extern int go_line_from_points(const go_cart *point1,
...
extern int go_line_from_planes(const go_plane *plane1,
...
extern int go_point_line_distance(const go_cart *point,
                                  const go_line *line,
                                  go_real *distance);

/*! Fills in \a pout with the nearest point on \a line to \a point */
extern int
go_point_line_proj(const go_cart *point, const go_line *line, go_cart *pout);

/*! Fills in \a proj with the projection of \a point onto \a plane */
extern int
go_point_plane_proj(const go_cart *point, const go_plane *plane, go_cart *proj);

/*! Fills in \a proj with the projection of \a line onto \a plane */
extern int
go_line_plane_proj(const go_line *line, const go_plane *plane, go_line *proj);

/*! Fills in \a plane give a \a point on the plane and the normal \a direction. */
extern int go_plane_from_point_normal(const go_cart *point,
...
extern int
go_plane_from_abcd(go_real A, go_real B, go_real C, go_real D, go_plane *plane);

/*! Fills in \a plane given three points. Returns GO_RESULT_OK
  if the points are distinct, otherwise GO_RESULT_ERROR. */
extern int go_plane_from_points(const go_cart *point1,
                                const go_cart *point2,
...
extern int go_plane_from_point_line(const go_cart *point,
                                    const go_line *line,
                                    go_plane *plane);

/*! Returns non-zero if the planes are coincident and have the same
  normal direction, otherwise zero. */
extern go_flag go_plane_plane_compare(const go_plane *plane1,
                                      const go_plane *plane2);

/*! Fills in the \a distance from the \a point to the \a plane.  */
extern int go_point_plane_distance(const go_cart *point,
...
extern int
go_plane_evaluate(const go_plane *plane, go_real u, go_real v, go_cart *point);
...
/*! Fills in \a point with the intersection point of
 ...
 GO_RESULT_OK. */
extern int go_line_plane_intersect(const go_line *line,
                                   const go_plane *plane,
                                   go_cart *point,
                                   go_real *distance);
...
extern int go_cart_cart_dot(const go_cart *, const go_cart *, go_real *);
extern int go_cart_cart_cross(const go_cart *, const go_cart *, go_cart *);
...
extern int
go_cart_cart_disp(const go_cart *v1, const go_cart *v2, go_real *disp);

extern int go_cart_cart_add(const go_cart *, const go_cart *, go_cart *);
extern int go_cart_cart_sub(const go_cart *, const go_cart *, go_cart *);
 ...
 */
extern int
go_cart_cart_rot(const go_cart *v1, const go_cart *v2, go_quat *quat);
...
*/
extern int
go_cart_cart_proj(const go_cart *v1, const go_cart *v2, go_cart *vout);
extern int go_cart_plane_proj(const go_cart *, const go_cart *, go_cart *);
extern int go_cart_cart_angle(const go_cart *, const go_cart *, go_real *);
/*!
...
extern int
go_cart_centroid(const go_cart *varray, go_integer num, go_cart *centroid);
extern int go_cart_centroidize(const go_cart *vinarray,
                               go_integer num,
                               go_cart *centroid,
                               go_cart *voutarray);
extern int go_cart_cart_pose(const go_cart *,
                             const go_cart *,
                             go_cart *,
                             go_cart *,
                             go_integer,
...
extern int go_quat_quat_mult(const go_quat *, const go_quat *, go_quat *);
extern int go_quat_cart_mult(const go_quat *, const go_cart *, go_cart *);
...
extern int go_pose_pose_interp(go_real t1,
                               const go_pose *p1,
                               go_real t2,
                               const go_pose *p2,
                               go_real t3,
...
extern int
go_pose_screw_mult(const go_pose *pose, const go_screw *screw, go_screw *out);
...
extern go_real go_get_singular_epsilon(void);

extern int go_set_singular_epsilon(go_real epsilon);

extern int ludcmp(go_real **a,
                  go_real *scratchrow,
                  go_integer n,
                  go_integer *indx,
                  go_real *d);

extern int lubksb(go_real **a, go_integer n, go_integer *indx, go_real *b);

/* MxN matrix, Mx1 vector functions */

extern int go_cart_vector_convert(const go_cart *c, go_vector *v);
extern int go_vector_cart_convert(const go_real *v, go_cart *c);

extern int go_quat_matrix_convert(const go_quat *quat, go_matrix *matrix);

extern int go_mat_matrix_convert(const go_mat *mat, go_matrix *matrix);

extern int
go_matrix_matrix_add(const go_matrix *a, const go_matrix *b, go_matrix *apb);

extern int go_matrix_matrix_copy(const go_matrix *src, go_matrix *dst);

extern int
go_matrix_matrix_mult(const go_matrix *a, const go_matrix *b, go_matrix *ab);

extern int
go_matrix_vector_mult(const go_matrix *a, const go_vector *v, go_vector *av);
...
*/
extern int
go_matrix_vector_cross(const go_matrix *a, const go_vector *v, go_matrix *axv);

extern int go_matrix_transpose(const go_matrix *a, go_matrix *at);

extern int go_matrix_inv(const go_matrix *a, go_matrix *ainv);
...
extern int go_mat3_mat3_mult(const go_real a[3][3],
                             ...
                             go_real axb[3][3]);
extern int
go_mat3_vec3_mult(const go_real a[3][3], const go_real v[3], go_real axv[3]);
...
extern int go_mat4_mat4_mult(const go_real a[4][4],
                             ...
                             go_real axb[4][4]);
extern int
go_mat4_vec4_mult(const go_real a[4][4], const go_real v[4], go_real axv[4]);
...
*/
extern int go_mat6_inv(const go_real a[6][6], go_real ainv[6][6]);
...
*/
extern int
go_mat6_vec6_mult(const go_real a[6][6], const go_real v[6], go_real axv[6]);
...
typedef struct {
    union {
        ...
        go_pk
            pk; /*< if you have a parallel machine, e.g., hexapod or robot crane */
        go_pp
...
*/
extern int
go_link_joint_set(const go_link *link, go_real joint, go_link *linkout);
...
*/
extern int
go_link_pose_build(const go_link *links, go_integer num, go_pose *pose);
...
extern void
go_complex_cbrt(go_complex z, go_complex *z1, go_complex *z2, go_complex *z3);
...
extern int
go_quadratic_solve(const go_quadratic *quad, go_complex *z1, go_complex *z2);
...
extern int go_tridiag_reduce(go_real **a, go_integer n, go_real *d, go_real *e);

extern int go_tridiag_ql(go_real *d, go_real *e, go_integer n, go_real **z);
