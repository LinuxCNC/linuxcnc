...
CMS_UPDATER::CMS_UPDATER(CMS *_cms_parent,
  ...
  *********************************************/
      ...
      status(_cms_parent->status), size(_cms_parent->size),
...
int CMS_UPDATER::set_mode(CMS_UPDATER_MODE _mode)
{
    mode = _mode;
    switch (mode) {
    case CMS_NO_UPDATE: break;

    case CMS_ENCODE_DATA: encoding = 1; break;

    case CMS_DECODE_DATA: encoding = 0; break;

    case CMS_ENCODE_HEADER: encoding = 1; break;

    case CMS_DECODE_HEADER: encoding = 0; break;

    case CMS_ENCODE_QUEUING_HEADER: encoding = 1; break;

    case CMS_DECODE_QUEUING_HEADER: encoding = 0; break;
...
void CMS_UPDATER::set_encoded_data(void *_encoded_data, long _encoded_data_size)
{
