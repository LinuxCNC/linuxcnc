...
BOOST_PYTHON_MODULE(emccanon)
{
    ...
    scope().attr("__doc__") = "Canon access & introspection\n";
    ...
    def("GET_EXTERNAL_ADAPTIVE_FEED_ENABLE",
        &GET_EXTERNAL_ADAPTIVE_FEED_ENABLE);
    ...
    def("GET_EXTERNAL_MOTION_CONTROL_TOLERANCE",
        &GET_EXTERNAL_MOTION_CONTROL_TOLERANCE);
    ...
    def("GET_EXTERNAL_SPINDLE_OVERRIDE_ENABLE",
    ...
    def("enqueue_START_SPINDLE_COUNTERCLOCKWISE",
