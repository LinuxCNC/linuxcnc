                         ...
                         setup_pointer settings)        //!< pointer to machine settings
{
  ...
  if (mode0 == -1) {
    ...
    CHKS((block->l_number != 2 && block->l_number != 1 && block->l_number != 20 && block->l_number != 10 && block->l_number != 11), "Line with G10 does not have L1, L10, L11, L2, or L20");
    ...
    CHKS((((block->l_number == 1 || block->l_number == 10 || block->l_number == 11) && p_int < 1)), "P value out of range with G10 L1 or G10 L10");
  } else if (mode0 == G_28) {
  } else if (mode0 == G_30) {
  } else if (mode0 == G_5_3) { 
