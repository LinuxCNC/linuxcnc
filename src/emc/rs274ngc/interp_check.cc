...
int Interp::check_other_codes(block_pointer block)       //!< pointer to a block of RS274/NGC instructions
{
  ...
  if (block->p_flag) {
      CHKS(((block->g_modes[GM_MODAL_0] != G_10) && (block->g_modes[GM_MODAL_0] != G_4) && (block->g_modes[GM_CONTROL_MODE] != G_64 && (block->g_modes[GM_MODAL_0] != G_12_1)) &&
          !plane_words &&
          (block->g_modes[GM_MODAL_0] != G_53_1) && (block->g_modes[GM_MODAL_0] != G_53_3) && (block->g_modes[GM_MODAL_0] != G_53_6) &&
	  ...
	  (block->g_modes[GM_MODAL_0] != G_28_2) &&
          ...
          (block->o_type != M_98)),
          _("P word with no G2 G3 G4 G10 G12.1 G53.1 G53.3 G53.6 G64 G68.2 G68.4 G5 G5.2 G6, G6.2, G76 G82 G86 G88 G89"
            " G28.2"
  ...
  if (block->q_number != -1.0) {
      CHKS((motion != G_83) && (motion != G_73) && (motion != G_5) && (motion != G_6) && (motion != G_6_2) && (block->user_m != 1) && (motion != G_76) &&
	   ...
	   (motion != G_72) && (motion != G_72_1) && (motion != G_72_2) &&
	   (block->m_modes[7] != 19),
	   _("Q word with no G5, G6, G10, G53.1, G53.3, G53.6, G64, G68.2, G68.4, G73, G76, G83, M19, M66, M67, M68 or user M code that uses it"));
  }
