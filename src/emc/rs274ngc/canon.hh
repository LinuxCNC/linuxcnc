...
struct CANON_POSITION
{
  ...
  CANON_POSITION(double _x, double _y, double _z, double _a, double _b,
                 double _c)
  {
    x = _x;
    y = _y;
...
extern void SET_ORIGIN_OFFSETS(double x, double y, double z, double a,
                               double b, double c);
...
extern void STRAIGHT_TRAVERSE(double x, double y, double z, double a_position,
...
extern void STRAIGHT_FEED(double x, double y, double z, double a_position,
                          double b_position, double c_position);
...
extern void STRAIGHT_PROBE(double x, double y, double z, double a_position,
                           double b_position, double c_position);
