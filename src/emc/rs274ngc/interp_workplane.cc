...
// The two point-to-point codes that name joints: G53.5 by axis letter through
// the module's identity mapping, refused where a letter names joints of the
// other unit class; G53.7 by J<n>=<value> in the joint's own units.  A joint
// left out keeps its position.
