...
#define NCE_NO_IDENTITY_KINEMATICS_TYPE _("G13.1 needs the kinematics module to declare its identity or machine frame type (see the switchkins documentation)")
