...
static int arc_data_comp_ijk(int move,  //!<either G_2 (cw arc) or G_3 (ccw arc)
...
static int arc_data_comp_r(int move,    //!< either G_2 (cw arc) or G_3 (ccw arc)
                           int side,    //!< either RIGHT or LEFT
                           double tool_radius,  //!< radius of the tool
                           double current_x,    //!< first coordinate of current point
                           double current_y,    //!< second coordinate of current point
...
static int arc_data_ijk(int move,       //!< either G_2 (cw arc) or G_3 (ccw arc)
                        double current_x,       //!< first coordinate of current point
                        double current_y,       //!< second coordinate of current point
                        double end_x,   //!< first coordinate of arc end point
                        double end_y,   //!< second coordinate of arc end point
...
static int arc_data_r(int move, //!< either G_2 (cw arc) or G_3 (ccw arc)
                      double current_x, //!< first coordinate of current point
                      double current_y, //!< second coordinate of current point
                      double end_x,     //!< first coordinate of arc end point
                      double end_y,     //!< second coordinate of arc end point
...
static int check_g_codes(block_pointer block,   //!< pointer to a block to be checked
...
static int check_items(block_pointer block,     //!< pointer to a block to be checked
                       setup_pointer settings)  //!< pointer to machine settings
{
...
static int check_m_codes(block_pointer block)   //!< pointer to a block to be checked
{
...
static int check_other_codes(block_pointer block)       //!< pointer to a block of RS274/NGC instructions
{
...
static int close_and_downcase(char *line)       //!< string: one line of NC code
{
...
static int convert_arc(int move,        //!< either G_2 (cw arc) or G_3 (ccw arc)    
...
static int convert_arc2(int move,       //!< either G_2 (cw arc) or G_3 (ccw arc)    
                        block_pointer block,    //!< pointer to a block of RS274 instructions
                        setup_pointer settings, //!< pointer to machine settings             
...
static int convert_arc_comp1(int move,  //!< either G_2 (cw arc) or G_3 (ccw arc)            
...
static int convert_arc_comp2(int move,  //!< either G_2 (cw arc) or G_3 (ccw arc)          
                             block_pointer block,       //!< pointer to a block of RS274/NGC instructions  
                             setup_pointer settings,    //!< pointer to machine settings                   
                             double end_x,      //!< x-value at end of programmed (then actual) arc
                             double end_y,      //!< y-value at end of programmed (then actual) arc
...
static int convert_axis_offsets(int g_code,     //!< g_code being executed (must be in G_92 series)
                                block_pointer block,    //!< pointer to a block of RS274/NGC instructions  
                                setup_pointer settings) //!< pointer to machine settings                   
{
...
static int convert_control_mode(int g_code,     //!< g_code being executed (G_61, G61_1, || G_64)
                                setup_pointer settings) //!< pointer to machine settings                 
{
...
static int convert_coordinate_system(int g_code,        //!< g_code called (must be one listed above)     
                                     setup_pointer settings)    //!< pointer to machine settings                  
{
...
static int convert_cutter_compensation(int g_code,      //!< must be G_40, G_41, or G_42             
                                       block_pointer block,     //!< pointer to a block of RS274 instructions
                                       setup_pointer settings)  //!< pointer to machine settings             
{
...
static int convert_cutter_compensation_off(setup_pointer settings)      //!< pointer to machine settings
{
#ifdef DEBUG_EMC
...
static int convert_cutter_compensation_on(int side,     //!< side of path cutter is on (LEFT or RIGHT)
                                          block_pointer block,  //!< pointer to a block of RS274 instructions 
                                          setup_pointer settings)       //!< pointer to machine settings              
{
...
static int convert_cycle(int motion,    //!< a g-code between G_81 and G_89, a canned cycle
                         block_pointer block,   //!< pointer to a block of RS274 instructions      
                         setup_pointer settings)        //!< pointer to machine settings                   
{
...
static int convert_cycle_g81(CANON_PLANE plane, //!< selected plane                  
...
static int convert_cycle_g82(CANON_PLANE plane, //!< selected plane                  
                             double x,  //!< x-value where cycle is executed 
                             double y,  //!< y-value where cycle is executed 
                             double clear_z,    //!< z-value of clearance plane      
                             double bottom_z,   //!< value of z at bottom of cycle   
...
static int convert_cycle_g83(CANON_PLANE plane, //!< selected plane                  
                             double x,  //!< x-value where cycle is executed 
                             double y,  //!< y-value where cycle is executed 
...
static int convert_cycle_g84(CANON_PLANE plane, //!< selected plane                     
                             double x,  //!< x-value where cycle is executed    
                             double y,  //!< y-value where cycle is executed    
                             double clear_z,    //!< z-value of clearance plane         
                             double bottom_z,   //!< value of z at bottom of cycle      
...
static int convert_cycle_g85(CANON_PLANE plane, //!< selected plane                  
                             double x,  //!< x-value where cycle is executed 
                             double y,  //!< y-value where cycle is executed 
                             double clear_z,    //!< z-value of clearance plane      
                             double bottom_z)   //!< value of z at bottom of cycle   
...
static int convert_cycle_g86(CANON_PLANE plane, //!< selected plane                     
                             double x,  //!< x-value where cycle is executed    
                             double y,  //!< y-value where cycle is executed    
                             double clear_z,    //!< z-value of clearance plane         
                             double bottom_z,   //!< value of z at bottom of cycle      
...
static int convert_cycle_g87(CANON_PLANE plane, //!< selected plane                     
                             double x,  //!< x-value where cycle is executed    
...
static int convert_cycle_g88(CANON_PLANE plane, //!< selected plane                     
                             double x,  //!< x-value where cycle is executed    
                             double y,  //!< y-value where cycle is executed    
                             double bottom_z,   //!< value of z at bottom of cycle      
                             double dwell,      //!< dwell time                         
...
static int convert_cycle_g89(CANON_PLANE plane, //!< selected plane                  
                             double x,  //!< x-value where cycle is executed 
                             double y,  //!< y-value where cycle is executed 
                             double clear_z,    //!< z-value of clearance plane      
                             double bottom_z,   //!< value of z at bottom of cycle   
...
static int convert_cycle_xy(int motion, //!< a g-code between G_81 and G_89, a canned cycle
                            block_pointer block,        //!< pointer to a block of RS274 instructions      
                            setup_pointer settings)     //!< pointer to machine settings                   
{
...
static int convert_cycle_yz(int motion, //!< a g-code between G_81 and G_89, a canned cycle
                            block_pointer block,        //!< pointer to a block of RS274/NGC instructions  
                            setup_pointer settings)     //!< pointer to machine settings                   
{
...
static int convert_cycle_zx(int motion, //!< a g-code between G_81 and G_89, a canned cycle
                            block_pointer block,        //!< pointer to a block of RS274 instructions      
                            setup_pointer settings)     //!< pointer to machine settings                   
{
...
static int convert_distance_mode(int g_code,    //!< g_code being executed (must be G_90 or G_91)
                                 setup_pointer settings)        //!< pointer to machine settings                 
{
...
static int convert_dwell(double time)   //!< time in seconds to dwell  */
{
  DWELL(time);
  return RS274NGC_OK;
}
...
static int convert_feed_mode(int g_code,        //!< g_code being executed (must be G_93 or G_94)
                             setup_pointer settings)    //!< pointer to machine settings                 
{
...
static int convert_feed_rate(block_pointer block,       //!< pointer to a block of RS274 instructions
                             setup_pointer settings)    //!< pointer to machine settings             
{
...
static int convert_g(block_pointer block,       //!< pointer to a block of RS274/NGC instructions
                     setup_pointer settings)    //!< pointer to machine settings                 
{
...
static int convert_home(int move,       //!< G code, must be G_28 or G_30            
                        block_pointer block,    //!< pointer to a block of RS274 instructions
                        setup_pointer settings) //!< pointer to machine settings             
{
...
static int convert_length_units(int g_code,     //!< g_code being executed (must be G_20 or G_21)
                                setup_pointer settings) //!< pointer to machine settings                 
{
...
static int convert_m(block_pointer block,       //!< pointer to a block of RS274/NGC instructions
                     setup_pointer settings)    //!< pointer to machine settings                 
{
...
static int convert_modal_0(int code,    //!< G code, must be from group 0                
                           block_pointer block, //!< pointer to a block of RS274/NGC instructions
                           setup_pointer settings)      //!< pointer to machine settings                 
{
...
static int convert_motion(int motion,   //!< g_code for a line, arc, canned cycle     
                          block_pointer block,  //!< pointer to a block of RS274 instructions 
                          setup_pointer settings)       //!< pointer to machine settings              
{
...
static int convert_probe(block_pointer block,   //!< pointer to a block of RS274 instructions
                         setup_pointer settings)        //!< pointer to machine settings             
{
...
static int convert_retract_mode(int g_code,     //!< g_code being executed (must be G_98 or G_99)
                                setup_pointer settings) //!< pointer to machine settings                 
{
...
static int convert_setup(block_pointer block,   //!< pointer to a block of RS274/NGC instructions
                         setup_pointer settings)        //!< pointer to machine settings                 
{
...
static int convert_set_plane(int g_code,        //!< must be G_17, G_18, or G_19 
                             setup_pointer settings)    //!< pointer to machine settings 
{
...
static int convert_speed(block_pointer block,   //!< pointer to a block of RS274 instructions
                         setup_pointer settings)        //!< pointer to machine settings             
{
...
static int convert_stop(block_pointer block,    //!< pointer to a block of RS274/NGC instructions
                        setup_pointer settings) //!< pointer to machine settings                 
{
...
static int convert_straight(int move,   //!< either G_0 or G_1                       
                            block_pointer block,        //!< pointer to a block of RS274 instructions
                            setup_pointer settings)     //!< pointer to machine settings             
{
...
static int convert_straight_comp1(int move,     //!< either G_0 or G_1                        
                                  block_pointer block,  //!< pointer to a block of RS274 instructions 
                                  setup_pointer settings,       //!< pointer to machine settings              
...
static int convert_straight_comp2(int move,     //!< either G_0 or G_1                        
                                  block_pointer block,  //!< pointer to a block of RS274 instructions 
                                  setup_pointer settings,       //!< pointer to machine settings              
...
static int convert_tool_change(setup_pointer settings)  //!< pointer to machine settings
{
...
static int convert_tool_length_offset(int g_code,       //!< g_code being executed (must be G_43 or G_49)
                                      block_pointer block,      //!< pointer to a block of RS274/NGC instructions
                                      setup_pointer settings)   //!< pointer to machine settings                 
{
...
static int convert_tool_select(block_pointer block,     //!< pointer to a block of RS274 instructions
                               setup_pointer settings)  //!< pointer to machine settings             
{
...
static int cycle_feed(CANON_PLANE plane,        //!< currently selected plane  
...
static int cycle_traverse(CANON_PLANE plane,    //!< currently selected plane 
                          double end1,  //!< first coordinate value   
                          double end2,  //!< second coordinate value  
                          double end3)  //!< third coordinate value   
{
...
static int enhance_block(block_pointer block,   //!< pointer to a block to be checked 
                         setup_pointer settings)        //!< pointer to machine settings      
{
...
static int execute_binary1(double *left,        //!< pointer to the left operand    
...
static int execute_binary2(double *left,        //!< pointer to the left operand    
                           int operation,       //!< integer code for the operation 
                           double *right)       //!< pointer to the right operand   
{
...
static int execute_block(block_pointer block,   //!< pointer to a block of RS274/NGC instructions
                         setup_pointer settings)        //!< pointer to machine settings                 
{
...
static int execute_unary(double *double_ptr,    //!< pointer to the operand         
                         int operation) //!< integer code for the operation 
{
...
static double find_arc_length(double x1,        //!< X-coordinate of start point       
...
static int find_ends(block_pointer block,       //!< pointer to a block of RS274/NGC instructions
                     setup_pointer settings,    //!< pointer to machine settings                 
...
static double find_straight_length(double x2,   //!< X-coordinate of end point   
                                   double y2,   //!< Y-coordinate of end point   
                                   double z2,   //!< Z-coordinate of end point   
#ifndef LATHE
...
static double find_turn(double x1,      //!< X-coordinate of start point       
                        double y1,      //!< Y-coordinate of start point       
                        double center_x,        //!< X-coordinate of arc center        
                        double center_y,        //!< Y-coordinate of arc center        
                        int turn,       //!< no. of full or partial circles CCW
...
static int init_block(block_pointer block)      //!< pointer to a block to be initialized or reset
{
  int n;
#ifndef LATHE
  block->a_flag = OFF;
...
static int inverse_time_rate_arc(double x1,     //!< x coord of start point of arc           
...
static int inverse_time_rate_arc2(double start_x,       //!< x coord of last program point, extra arc center x
...
static int inverse_time_rate_as(double start_x, //!< x coord of last program point, extra arc center x
                                double start_y, //!< y coord of last program point, extra arc center y
...
static int parse_line(char *line,       //!< array holding a line of RS274 code  
...
static int read_a(char *line,   //!< string: line of RS274/NGC code being processed
...
static int read_atan(char *line,        //!< string: line of RS274/NGC code being processed
...
static int read_b(char *line,   //!< string: line of RS274/NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_c(char *line,   //!< string: line of RS274/NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_comment(char *line,     //!< string: line of RS274 code being processed   
                        int *counter,   //!< pointer to a counter for position on the line
                        block_pointer block,    //!< pointer to a block being filled from the line
                        double *parameters)     //!< array of system parameters                   
{
...
static int read_d(char *line,   //!< string: line of RS274 code being processed   
                  int *counter, //!< pointer to a counter for position on the line
                  block_pointer block,  //!< pointer to a block being filled from the line
                  double *parameters)   //!< array of system parameters                   
{
...
static int read_f(char *line,   //!< string: line of RS274 code being processed   
                  int *counter, //!< pointer to a counter for position on the line
                  block_pointer block,  //!< pointer to a block being filled from the line
                  double *parameters)   //!< array of system parameters                   
{
...
static int read_g(char *line,   //!< string: line of RS274/NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_h(char *line,   //!< string: line of RS274/NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_i(char *line,   //!< string: line of RS274 code being processed    
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_integer_unsigned(char *line,    //!< string: line of RS274 code being processed   
                                 int *counter,  //!< pointer to a counter for position on the line
...
static int read_integer_value(char *line,       //!< string: line of RS274/NGC code being processed
                              int *counter,     //!< pointer to a counter for position on the line 
                              int *integer_ptr, //!< pointer to the value being read               
                              double *parameters)       //!< array of system parameters                    
{
...
static int read_items(block_pointer block,      //!< pointer to a block being filled from the line 
...
static int read_j(char *line,   //!< string: line of RS274 code being processed    
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_k(char *line,   //!< string: line of RS274 code being processed    
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_l(char *line,   //!< string: line of RS274/NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_line_number(char *line, //!< string: line of RS274    code being processed 
                            int *counter,       //!< pointer to a counter for position on the line 
                            block_pointer block)        //!< pointer to a block being filled from the line 
{
...
static int read_m(char *line,   //!< string: line of RS274 code being processed   
                  int *counter, //!< pointer to a counter for position on the line
                  block_pointer block,  //!< pointer to a block being filled from the line
                  double *parameters)   //!< array of system parameters                   
{
...
static int read_one_item(char *line,    //!< string: line of RS274/NGC code being processed
                         int *counter,  //!< pointer to a counter for position on the line 
                         block_pointer block,   //!< pointer to a block being filled from the line 
                         double *parameters)    //!< array of system parameters                    
{
...
static int read_operation(char *line,   //!< string: line of RS274/NGC code being processed
                          int *counter, //!< pointer to a counter for position on the line 
...
static int read_operation_unary(char *line,     //!< string: line of RS274/NGC code being processed
                                int *counter,   //!< pointer to a counter for position on the line 
                                int *operation) //!< pointer to operation to be read               
{
...
static int read_p(char *line,   //!< string: line of RS274/NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_parameter(char *line,   //!< string: line of RS274/NGC code being processed
                          int *counter, //!< pointer to a counter for position on the line 
                          double *double_ptr,   //!< pointer to double to be read                  
                          double *parameters)   //!< array of system parameters                    
{
...
static int read_parameter_setting(char *line,   //!< string: line of RS274/NGC code being processed
                                  int *counter, //!< pointer to a counter for position on the line 
                                  block_pointer block,  //!< pointer to a block being filled from the line 
                                  double *parameters)   //!< array of system parameters                    
{
...
static int read_q(char *line,   //!< string: line of RS274/NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_r(char *line,   //!< string: line of RS274 code being processed   
                  int *counter, //!< pointer to a counter for position on the line
                  block_pointer block,  //!< pointer to a block being filled from the line
                  double *parameters)   //!< array of system parameters                   
{
...
#ifdef UNDEFINED
static int read_real_expression(char *line,     //!< string: line of RS274/NGC code being processed
                                int *counter,   //!< pointer to a counter for position on the line 
...
static int read_real_number(char *line, //!< string: line of RS274/NGC code being processed
                            int *counter,       //!< pointer to a counter for position on the line 
                            double *double_ptr) //!< pointer to double to be read                  
{
...
static int read_real_value(char *line,  //!< string: line of RS274/NGC code being processed
                           int *counter,        //!< pointer to a counter for position on the line 
                           double *double_ptr,  //!< pointer to double to be read                  
                           double *parameters)  //!< array of system parameters                    
{
...
#ifdef UNDEFINED
static int read_rest_bop1(char *line,   //!< string: line of RS274/NGC code being processed
                          int *counter, //!< pointer to a counter for position on the line 
...
#ifdef UNDEFINED
static int read_rest_bop2(char *line,   //!< string: line of RS274/NGC code being processed
                          int *counter, //!< pointer to a counter for position on the line 
                          double *value,        //!< pointer to double to be calculated            
...
static int read_s(char *line,   //!< string: line of RS274NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line
                  block_pointer block,  //!< pointer to a block being filled from the line
                  double *parameters)   //!< array of system parameters                   
{
...
static int read_t(char *line,   //!< string: line of RS274/NGC code being processed
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_text(const char *command,       //!< a string which may have input text, or null
...
static int read_unary(char *line,       //!< string: line of RS274/NGC code being processed
                      int *counter,     //!< pointer to a counter for position on the line 
                      double *double_ptr,       //!< pointer to double to be read                  
                      double *parameters)       //!< array of system parameters                    
{
...
static int read_x(char *line,   //!< string: line of RS274 code being processed    
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_y(char *line,   //!< string: line of RS274 code being processed    
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int read_z(char *line,   //!< string: line of RS274 code being processed    
                  int *counter, //!< pointer to a counter for position on the line 
                  block_pointer block,  //!< pointer to a block being filled from the line 
                  double *parameters)   //!< array of system parameters                    
{
...
static int set_probe_data(setup_pointer settings)       //!< pointer to machine settings
{
...
static int write_g_codes(block_pointer block,   //!< pointer to a block of RS274/NGC instructions
                         setup_pointer settings)        //!< pointer to machine settings                 
{
  int *gez;
...
static int write_m_codes(block_pointer block,   //!< pointer to a block of RS274/NGC instructions
                         setup_pointer settings)        //!< pointer to machine settings                 
{
  int *emz;
...
static int write_settings(setup_pointer settings)       //!< pointer to machine settings
{
  double *vals;
...
int rs274ngc_open(const char *filename) //!< string: the name of the input NC-program file
{
...
int rs274ngc_read(const char *command)  //!< may be NULL or a string to read
{
...
*/
int rs274ngc_restore_parameters(const char *filename)   //!< name of parameter file to read  
{
...
*/
int rs274ngc_save_parameters(const char *filename,      //!< name of file to write
...
void rs274ngc_active_g_codes(int *codes)        //!< array of codes to copy into
{
  int n;
...
void rs274ngc_active_m_codes(int *codes)        //!< array of codes to copy into
{
  int n;
...
void rs274ngc_active_settings(double *settings) //!< array of settings to copy into
{
  int n;
...
void rs274ngc_error_text(int error_code,        //!< code number of error                
...
void rs274ngc_file_name(char *file_name,        //!< string: to copy file name into      
                        int max_size)   //!< maximum number of characters to copy
{
...
void rs274ngc_line_text(char *line_text,        //!< string: to copy line into           
                        int max_size)   //!< maximum number of characters to copy
{
  int n;
  char *the_text;
...
void rs274ngc_stack_name(int stack_index,       //!< index into stack of function names  
