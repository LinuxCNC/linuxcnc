...
extern double
    prf_blend((double *v, double vel, double max_vel, double max_accel);
	      ...
	      extern void prf_multiply(double *a, double *b,
				       double *result);
	      ...
	      extern void prf_scale(double *a, double *result,
				    double scale);
	      ...
	      extern void prf_interpolate(double *a, double *b,
