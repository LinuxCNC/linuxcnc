...
class Pages:
    ...
    def on_button_fwd_clicked(self, widget):
        ...
        while u < len(self._p.available_page):
            ...
            dbg(
                "FWD search %s,%s,%s,%s,of %d pages"
                % (u, name, text, state, len(self._p.available_page) - 1)
            )
            if state:
    ...
    def on_button_back_clicked(self, widget):
        ...
        while u > -1:
            name, text, state = self._p.available_page[u]
            dbg(
                "BACK search %s,%s,%s,%s,of %d pages"
                % (u, name, text, state, len(self._p.available_page) - 1)
            )
            if state:
    ...
    def initialize(self):
        ...
        model.clear()
        for name in self._p.human_output_names:
            model.append((name,))
        model = self.w.input_list
        model.clear()
        for name in self._p.human_input_names:
            model.append((name,))
        # parport io preset
    ...
    def start_finish(self):
        if self.w.importmach.get_active():
            ...
            if not self.d._lastconfigname == "" and self.d._chooselastconfig:
                dialog.set_filename(
                    os.path.expanduser(
                        "~/linuxcnc/configs/%s.stepconf" % self.d._lastconfigname
                    )
                )
    ...
    def options_prepare(self):
        ...
        if not self.w.createconfig.get_active():
            if os.path.exists(
                os.path.expanduser(
                    "~/linuxcnc/configs/%s/custompanel.xml" % self.d.machinename
                )
            ):
    ...
    def options_finish(self):
        SIG = self._p
        self.d.select_axis = self.d.select_gmoccapy = self.d.select_qtdragon = (
            self.d.select_qtplasmac
        ) = False
        ...
        self.d.pyvcpconnect = (
            self.w.pyvcpconnect.get_active() and not self.d.select_qtplasmac
        )
        self.d.ladderconnect = self.w.ladderconnect.get_active()
        self.d.manualtoolchange = (
            self.w.manualtoolchange.get_active() and not self.d.select_qtplasmac
        )
        ...
        self.page_set_state(
            "spindle",
            (
                (self.a.has_spindle_speed_control() or self.a.has_spindle_encoder())
    ...
    def thcad_finish(self):
        self.d.voltsmodel = ["2 (W1 down)", "2 (W1 up)", "5", "10", "300"][
            self.w.voltsmodel.get_active()
        ]
    ...
    # AXIS X callbacks
    def on_xsteprev_changed(self, *args):
        self.a.update_pps("x")

    def on_xmicrostep_changed(self, *args):
        self.a.update_pps("x")

    def on_xpulleyden_changed(self, *args):
        self.a.update_pps("x")

    def on_xpulleynum_changed(self, *args):
        self.a.update_pps("x")

    def on_xleadscrew_changed(self, *args):
        self.a.update_pps("x")

    def on_xmaxvel_changed(self, *args):
        self.a.update_pps("x")

    def on_xmaxacc_changed(self, *args):
        self.a.update_pps("x")
    ...
    # AXIS Y callbacks
    def on_ysteprev_changed(self, *args):
        self.a.update_pps("y")

    def on_ymicrostep_changed(self, *args):
        self.a.update_pps("y")

    def on_ypulleyden_changed(self, *args):
        self.a.update_pps("y")

    def on_ypulleynum_changed(self, *args):
        self.a.update_pps("y")

    def on_yleadscrew_changed(self, *args):
        self.a.update_pps("y")

    def on_ymaxvel_changed(self, *args):
        self.a.update_pps("y")

    def on_ymaxacc_changed(self, *args):
        self.a.update_pps("y")
    ...
    # AXIS Z callbacks
    def on_zsteprev_changed(self, *args):
        self.a.update_pps("z")

    def on_zmicrostep_changed(self, *args):
        self.a.update_pps("z")

    def on_zpulleyden_changed(self, *args):
        self.a.update_pps("z")

    def on_zpulleynum_changed(self, *args):
        self.a.update_pps("z")

    def on_zleadscrew_changed(self, *args):
        self.a.update_pps("z")

    def on_zmaxvel_changed(self, *args):
        self.a.update_pps("z")

    def on_zmaxacc_changed(self, *args):
        self.a.update_pps("z")
    ...
    # AXIS U callbacks
    def on_usteprev_changed(self, *args):
        self.a.update_pps("u")

    def on_umicrostep_changed(self, *args):
        self.a.update_pps("u")

    def on_upulleyden_changed(self, *args):
        self.a.update_pps("u")

    def on_upulleynum_changed(self, *args):
        self.a.update_pps("u")

    def on_uleadscrew_changed(self, *args):
        self.a.update_pps("u")

    def on_umaxvel_changed(self, *args):
        self.a.update_pps("u")

    def on_umaxacc_changed(self, *args):
        self.a.update_pps("u")

    def on_uaxistest_clicked(self, *args):
        self.a.test_axis("u")
    ...
    # AXIS V callbacks
    def on_vsteprev_changed(self, *args):
        self.a.update_pps("v")

    def on_vmicrostep_changed(self, *args):
        self.a.update_pps("v")

    def on_vpulleyden_changed(self, *args):
        self.a.update_pps("v")

    def on_vpulleynum_changed(self, *args):
        self.a.update_pps("v")

    def on_vleadscrew_changed(self, *args):
        self.a.update_pps("v")

    def on_vmaxvel_changed(self, *args):
        self.a.update_pps("v")

    def on_vmaxacc_changed(self, *args):
        self.a.update_pps("v")

    def on_vaxistest_clicked(self, *args):
        self.a.test_axis("v")
    ...
    # AXIS A callbacks
    def on_asteprev_changed(self, *args):
        self.a.update_pps("a")

    def on_amicrostep_changed(self, *args):
        self.a.update_pps("a")

    def on_apulleyden_changed(self, *args):
        self.a.update_pps("a")

    def on_apulleynum_changed(self, *args):
        self.a.update_pps("a")

    def on_aleadscrew_changed(self, *args):
        self.a.update_pps("a")

    def on_amaxvel_changed(self, *args):
        self.a.update_pps("a")

    def on_amaxacc_changed(self, *args):
        self.a.update_pps("a")
