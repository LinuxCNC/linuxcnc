...
if aActive == "1":
    ...
    amaxlim = float(
        str(xmlTag.replace("<M3Max>", "").replace("</M3Max>", "")).rstrip(".")
    )
    xmlTag = dom.getElementsByTagName("M3Min")[0].toxml()
    aminlim = float(
        str(xmlTag.replace("<M3Min>", "").replace("</M3Min>", "")).rstrip(".")
    )
    try:
...
sc.write(
    f'  <property name="aleadscrew" type="float" value="{aleadscrew}"/>\n'.encode()
)
...
sc.write(
    f'  <property name="machinename" type="string" value="{machinename}"/>\n'.encode()
)
...
sc.write(
    f'  <property name="pin10inv" type="bool" value="{dInvert["10"]}"/>\n'.encode()
)
sc.write(f'  <property name="pin11" type="string" value="{dPins["11"]}"/>\n'.encode())
sc.write(
    f'  <property name="pin11inv" type="bool" value="{dInvert["11"]}"/>\n'.encode()
)
sc.write(f'  <property name="pin12" type="string" value="{dPins["12"]}"/>\n'.encode())
sc.write(
    f'  <property name="pin12inv" type="bool" value="{dInvert["12"]}"/>\n'.encode()
)
sc.write(f'  <property name="pin13" type="string" value="{dPins["13"]}"/>\n'.encode())
sc.write(
    f'  <property name="pin13inv" type="bool" value="{dInvert["13"]}"/>\n'.encode()
)
sc.write(f'  <property name="pin14" type="string" value="{dPins["14"]}"/>\n'.encode())
sc.write(
    f'  <property name="pin14inv" type="bool" value="{dInvert["14"]}"/>\n'.encode()
)
sc.write(f'  <property name="pin15" type="string" value="{dPins["15"]}"/>\n'.encode())
sc.write(
    f'  <property name="pin15inv" type="bool" value="{dInvert["15"]}"/>\n'.encode()
)
sc.write(f'  <property name="pin16" type="string" value="{dPins["16"]}"/>\n'.encode())
sc.write(
    f'  <property name="pin16inv" type="bool" value="{dInvert["16"]}"/>\n'.encode()
)
sc.write(f'  <property name="pin17" type="string" value="{dPins["17"]}"/>\n'.encode())
sc.write(
    f'  <property name="pin17inv" type="bool" value="{dInvert["17"]}"/>\n'.encode()
)
...
sc.write(
    f'  <property name="xleadscrew" type="float" value="{xleadscrew}"/>\n'.encode()
)
...
sc.write(
    f'  <property name="yleadscrew" type="float" value="{xleadscrew}"/>\n'.encode()
)
...
sc.write(
    f'  <property name="zleadscrew" type="float" value="{zleadscrew}"/>\n'.encode()
)
...
rm.write(
    "Copy the generated .stepconf file to the linuxcnc/configs directory.\n".encode()
)
...
rm.write(
    "If the file did not show up then you have not copied it to the correct directory.\n".encode()
)
rm.write("Run the latency test on page three with Test Base Period Jitter.\n".encode())
rm.write(
    "Allow the test to run for at least a hour then enter the largest Max Jitter.\n".encode()
)
rm.write(
    "Go through each screen and check for correctness then save when done.".encode()
)
rm.close()
