...
static int init_hal_io(void)
{
    ...
    if ((retval = hal_pin_bit_newf(HAL_OUT, &(emcmot_hal_data->spindle_orient_fwd), mot_comp_id, "motion.spindle-orient-fwd")) < 0) goto error;
    ...
    *(emcmot_hal_data->spindle_orient_fwd) = 1;
