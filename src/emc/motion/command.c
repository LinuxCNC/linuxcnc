...
//		joint->free_tp.pos_cmd = joint->max_jog_limit;
                simple_tp_jog_cont(&(joint->free_tp), joint->max_pos_limit - 10, emcmotCommand->vel, joint->vel_limit, joint->acc_limit, 20000);
	    } else {
//		joint->free_tp.pos_cmd = joint->min_jog_limit;
                simple_tp_jog_cont(&(joint->free_tp), joint->min_pos_limit + 10, emcmotCommand->vel, joint->vel_limit, joint->acc_limit, 20000);
	    }
	    /* set velocity of jog */
