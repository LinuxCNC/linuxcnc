/*
  ...
  4-May-2004  FMP added printing of axis acceleration limits
  23-Feb-2003 P.C. Test for shared memory in usrmotExit to avoid a
  segmentation when releasing memory.
  25-Sep-2002 P.C. Merged Jon Elson's ppmc changes.
