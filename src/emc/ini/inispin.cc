...
static int loadSpindle()
{
  ...
  if (NULL != (inistring = spindleInifile->find("SPINDLE_OFF_WAIT", "EMCIO")))
    {
  ...
  if (NULL != (inistring = spindleInifile->find("SPINDLE_ON_WAIT", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%lf", &d))
        {
          // found, and valid
  ...
  if (NULL != (inistring = spindleInifile->find("SPINDLE_FORWARD_INDEX", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          ...
          if (0 != emcSpindleSetForwardIndex(i))
            {
              printf("bad return value from emcSpindleSetForwardIndex\n");
              retval = -1;
            }
        }
      else
  ...
  if (NULL != (inistring = spindleInifile->find("SPINDLE_REVERSE_INDEX", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetReverseIndex(i))
            {
              printf("bad return value from emcSpindleSetReverseIndex\n");
              retval = -1;
            }
        }
      else
  ...
  if (NULL != (inistring = spindleInifile->find("SPINDLE_DECREASE_INDEX", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetDecreaseIndex(i))
            {
              printf("bad return value from emcSpindleSetDecreaseIndex\n");
              retval = -1;
            }
        }
      else
        {
          // found, but invalid, so warn
          printf("invalid inifile value for SPINDLE_DECREASE_INDEX: %s\n",
                          inistring);
        }
    }
  // else ignore omission

  if (NULL != (inistring = spindleInifile->find("SPINDLE_INCREASE_INDEX", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetIncreaseIndex(i))
            {
              printf("bad return value from emcSpindleSetIncreaseIndex\n");
              retval = -1;
            }
        }
      else
        {
          // found, but invalid, so warn
          printf("invalid inifile value for SPINDLE_INCREASE_INDEX: %s\n",
                          inistring);
        }
    }
  // else ignore omission

  if (NULL != (inistring = spindleInifile->find("SPINDLE_BRAKE_INDEX", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
  ...
  if (NULL != (inistring = spindleInifile->find("SPINDLE_ENABLE_INDEX", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
  ...
  if (NULL != (inistring = spindleInifile->find("MIN_VOLTS_PER_RPM", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%lf", &d))
        {
          // found, and valid
  ...
  if (NULL != (inistring = spindleInifile->find("MAX_VOLTS_PER_RPM", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%lf", &d))
        {
          // found, and valid
  ...
  // else ignore omission
  if (NULL != (inistring = spindleInifile->find("SPINDLE_ON_INDEX", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
  ...
  // else ignore omission
  if (NULL != (inistring = spindleInifile->find("SPINDLE_FORWARD_POLARITY", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetForwardPolarity(i))
            {
              printf("bad return value from emcSpindleSetSpindleForwardPolarity\n");
              retval = -1;
            }
        }
      else
        {
          // found, but invalid, so warn
          printf("invalid inifile value for SPINDLE_FORWARD_POLARITY: %s\n",
                          inistring);
        }
    }
  // else ignore omission

  if (NULL != (inistring = spindleInifile->find("SPINDLE_REVERSE_POLARITY", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetReversePolarity(i))
            {
              printf("bad return value from emcSpindleSetReversePolarity\n");
              retval = -1;
            }
        }
      else
        {
          // found, but invalid, so warn
          printf("invalid inifile value for SPINDLE_REVERSE_POLARITY: %s\n",
                          inistring);
        }
    }
  // else ignore omission

  if (NULL != (inistring = spindleInifile->find("SPINDLE_DECREASE_POLARITY", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetDecreasePolarity(i))
            {
              printf("bad return value from emcSpindleSetDecreasePolarity\n");
              retval = -1;
            }
        }
      else
        {
          // found, but invalid, so warn
          printf("invalid inifile value for SPINDLE_DECREASE_POLARITY: %s\n",
                          inistring);
        }
    }
  // else ignore omission

  if (NULL != (inistring = spindleInifile->find("SPINDLE_INCREASE_POLARITY", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetIncreasePolarity(i))
            {
              printf("bad return value from emcSpindleSetIncreasePolarity\n");
              retval = -1;
            }
        }
      else
        {
          // found, but invalid, so warn
          printf("invalid inifile value for SPINDLE_INCREASE_POLARITY: %s\n",
                          inistring);
        }
    }
  // else ignore omission

  if (NULL != (inistring = spindleInifile->find("SPINDLE_BRAKE_POLARITY", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetBrakePolarity(i))
            {
              printf("bad return value from emcSpindleSetBrakePolarity\n");
              retval = -1;
            }
        }
      else
        {
          // found, but invalid, so warn
          printf("invalid inifile value for SPINDLE_BRAKE_POLARITY: %s\n",
                          inistring);
        }
    }
  // else ignore omission

  if (NULL != (inistring = spindleInifile->find("SPINDLE_ENABLE_POLARITY", "EMCIO")))
    {
      if (1 == sscanf(inistring, "%d", &i))
        {
          // found, and valid
          if (0 != emcSpindleSetEnablePolarity(i))
            {
              printf("bad return value from emcSpindleSetEnablePolarity\n");
              retval = -1;
            }
        }
      else
        {
          // found, but invalid, so warn
          printf("invalid inifile value for SPINDLE_ENABLE_POLARITY: %s\n",
                          inistring);
        }
    }
  // else ignore omission
