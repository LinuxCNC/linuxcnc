...
static int loadLube()
{
    ...
    if (NULL !=
	(inistring = lubeInifile->find("LUBE_SENSE_INDEX", "EMCIO"))) {
    ...
    if (NULL !=
	(inistring = lubeInifile->find("LUBE_SENSE_POLARITY", "EMCIO"))) {
	if (1 == sscanf(inistring, "%d", &i)) {
	    // found, and valid
    ...
    if (NULL !=
	(inistring = lubeInifile->find("LUBE_WRITE_INDEX", "EMCIO"))) {
	if (1 == sscanf(inistring, "%d", &i)) {
	    // found, and valid
    ...
    if (NULL !=
	(inistring = lubeInifile->find("LUBE_WRITE_POLARITY", "EMCIO"))) {
	if (1 == sscanf(inistring, "%d", &i)) {
	    // found, and valid
