...
int main(int argc, char * argv[])
{
  ...
  while (! done) {
    ...
    case EMC_SPINDLE_ON_TYPE:
      rtapi_print_msg(RTAPI_MSG_DBG, "EMC_SPINDLE_ON\n");
    ...
    case EMC_SPINDLE_FORWARD_TYPE:
      rtapi_print_msg(RTAPI_MSG_DBG, "EMC_SPINDLE_FORWARD\n");
      emcioStatus.spindle.direction = 1;
      emcioStatus.spindle.brake = 0;
      break;

    case EMC_SPINDLE_REVERSE_TYPE:
      rtapi_print_msg(RTAPI_MSG_DBG, "EMC_SPINDLE_REVERSE\n");
      emcioStatus.spindle.direction = -1;
      emcioStatus.spindle.brake = 0;
      break;
    ...
    case EMC_SPINDLE_INCREASE_TYPE:
      rtapi_print_msg(RTAPI_MSG_DBG, "EMC_SPINDLE_INCREASE\n");
      emcioStatus.spindle.increasing = 1;
      emcioStatus.spindle.brake = 0;
      break;

    case EMC_SPINDLE_DECREASE_TYPE:
      rtapi_print_msg(RTAPI_MSG_DBG, "EMC_SPINDLE_DECREASE\n");
      emcioStatus.spindle.increasing = -1;
      emcioStatus.spindle.brake = 0;
      break;

    case EMC_SPINDLE_CONSTANT_TYPE:
      rtapi_print_msg(RTAPI_MSG_DBG, "EMC_SPINDLE_CONSTANT\n");
      emcioStatus.spindle.increasing = 0;
      emcioStatus.spindle.brake = 0;
      break;
