...
int emcFormat(NMLTYPE type, void *buffer, CMS * cms)
{
	...
	((EMC_WORKLIGHT_OFF *) buffer)->update(cms);
	break;
    case EMC_WORKLIGHT_ON_TYPE:
	((EMC_WORKLIGHT_ON *) buffer)->update(cms);
	break;
    case EMC_WORKLIGHT_STAT_TYPE:
	((EMC_WORKLIGHT_STAT *) buffer)->update(cms);
	break;
...
const char *emc_symbol_lookup(uint32_t type)
{
    ...
    case EMC_WORKLIGHT_OFF_TYPE:
	return "EMC_WORKLIGHT_OFF";
    case EMC_WORKLIGHT_ON_TYPE:
	return "EMC_WORKLIGHT_ON";
    case EMC_WORKLIGHT_STAT_TYPE:
	return "EMC_WORKLIGHT_STAT";
    case EMC_MOTION_ABORT_TYPE:
...
/*
*	NML/CMS Update function for EMC_WORKLIGHT_CMD_MSG
*/
void EMC_WORKLIGHT_CMD_MSG::update(CMS * cms)
{
...
/*
*	NML/CMS Update function for EMC_WORKLIGHT_STAT_MSG
*/
void EMC_WORKLIGHT_STAT_MSG::update(CMS * cms)
{

}

/*
*	NML/CMS Update function for EMC_WORKLIGHT_STAT
*/
void EMC_WORKLIGHT_STAT::update(CMS * cms)
{

    EMC_WORKLIGHT_STAT_MSG::update(cms);
    cms->update(on);
...
/*
*	NML/CMS Update function for EMC_WORKLIGHT_OFF
*/
void EMC_WORKLIGHT_OFF::update(CMS * cms)
{

    EMC_WORKLIGHT_CMD_MSG::update(cms);

}

/*
*	NML/CMS Update function for EMC_WORKLIGHT_ON
*/
void EMC_WORKLIGHT_ON::update(CMS * cms)
{
