...
*	This file should be named emc.cpp
*/
...
*	on Wed Dec 24 18:04:57 UTC 2003
*/
int emcFormat(NMLTYPE type, void *buffer, CMS *cms)
{
	...
	case EMC_AXIS_ALTER_TYPE:
		((EMC_AXIS_ALTER *) buffer)->update(cms);
		break;
	...
	case EMC_AXIS_SET_HOME_OFFSET_TYPE:
		((EMC_AXIS_SET_HOME_OFFSET *) buffer)->update(cms);
		break;
	case EMC_AXIS_SET_HOMING_VEL_TYPE:
		((EMC_AXIS_SET_HOMING_VEL *) buffer)->update(cms);
		break;
	...
	case EMC_LOG_CLOSE_TYPE:
		((EMC_LOG_CLOSE *) buffer)->update(cms);
		break;
	case EMC_LOG_OPEN_TYPE:
		((EMC_LOG_OPEN *) buffer)->update(cms);
		break;
	case EMC_LOG_START_TYPE:
		((EMC_LOG_START *) buffer)->update(cms);
		break;
	case EMC_LOG_STOP_TYPE:
		((EMC_LOG_STOP *) buffer)->update(cms);
		break;
...
const char *emc_symbol_lookup(long type)
{
	...
	case EMC_AXIS_SET_HOME_OFFSET_TYPE:
		return "EMC_AXIS_SET_HOME_OFFSET";
	case EMC_AXIS_SET_HOMING_VEL_TYPE:
		return "EMC_AXIS_SET_HOMING_VEL";
	case EMC_AXIS_SET_INPUT_SCALE_TYPE:
	...
	case EMC_IO_STAT_TYPE:
		return "EMC_IO_STAT";
	case EMC_LOG_CLOSE_TYPE:
		return "EMC_LOG_CLOSE";
	case EMC_LOG_OPEN_TYPE:
		return "EMC_LOG_OPEN";
	case EMC_LOG_START_TYPE:
		return "EMC_LOG_START";
	case EMC_LOG_STOP_TYPE:
		return "EMC_LOG_STOP";
	case EMC_LUBE_ABORT_TYPE:
...
/*
*	NML/CMS Update function for EMC_LOG_CLOSE
*	Automatically generated by NML CodeGen Java Applet.
*	on Wed Dec 24 18:04:57 UTC 2003
*/
void EMC_LOG_CLOSE::update(CMS *cms)
{
...
/*
*	NML/CMS Update function for EMC_LOG_OPEN
*	Automatically generated by NML CodeGen Java Applet.
*	on Wed Dec 24 18:04:57 UTC 2003
*/
void EMC_LOG_OPEN::update(CMS *cms)
{
	...
	cms->update(skip);
	cms->update(which);
	cms->update(triggerType);
	cms->update(triggerVar);
	cms->update(triggerThreshold);

}


/*
*	NML/CMS Update function for EMC_AXIS_SET_HOME
*	Automatically generated by NML CodeGen Java Applet.
*	on Wed Dec 24 18:04:57 UTC 2003
*/
...
/*
*	NML/CMS Update function for EMC_LOG_STOP
*	Automatically generated by NML CodeGen Java Applet.
*	on Wed Dec 24 18:04:57 UTC 2003
*/
void EMC_LOG_STOP::update(CMS *cms)
{
...
void EMC_STAT::update(CMS *cms)
{
	...
	motion.update(cms);
	io.update(cms);
	cms->update(logFile,256);
	cms->update(logType);
	cms->update(logSize);
	cms->update(logSkip);
	cms->update(logOpen);
	cms->update(logStarted);
	cms->update(logPoints);
	cms->update(debug);
...
/*
*	NML/CMS Update function for EMC_AXIS_ALTER
*	Automatically generated by NML CodeGen Java Applet.
*	on Wed Dec 24 18:04:57 UTC 2003
*/
...
/*
*	NML/CMS Update function for EMC_LOG_START
*	Automatically generated by NML CodeGen Java Applet.
*	on Wed Dec 24 18:04:57 UTC 2003
*/
void EMC_LOG_START::update(CMS *cms)
{
...
/*
*	NML/CMS Update function for EMC_AXIS_SET_HOMING_VEL
*	Automatically generated by NML CodeGen Java Applet.
*	on Wed Dec 24 18:04:57 UTC 2003
*/
void EMC_AXIS_SET_HOMING_VEL::update(CMS *cms)
{
...
/*
*	NML/CMS Update function for EMC_AXIS_SET_HOME_OFFSET
*	Automatically generated by NML CodeGen Java Applet.
*	on Wed Dec 24 18:04:58 UTC 2003
*/
void EMC_AXIS_SET_HOME_OFFSET::update(CMS *cms)
{
