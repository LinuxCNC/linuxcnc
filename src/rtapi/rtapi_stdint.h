...
#define RTAPI_INT32_MAX (2147483647l)
#define RTAPI_INT32_MIN (-2147483648l)
#define RTAPI_UINT32_MAX (4294967295ul)

#define RTAPI_INT64_MAX (9223372036854775807ll)
#define RTAPI_INT64_MIN (-9223372036854775808ll)
