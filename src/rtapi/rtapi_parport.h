...
static inline void rtapi_parport_control_write(rtapi_parport_t *t,
                                               unsigned char v)
{
    (void)t;
    (void)v;
...
static inline void rtapi_parport_status_write(rtapi_parport_t *t,
                                              unsigned char v)
{
    (void)t;
    (void)v;
...
static inline void rtapi_parport_epp_addr_write(rtapi_parport_t *t,
                                                unsigned char v)
{
    (void)t;
    (void)v;
...
static inline void rtapi_parport_epp_data_writeb(rtapi_parport_t *t,
                                                 unsigned char v)
{
    (void)t;
    (void)v;
...
static inline void rtapi_parport_epp_data_writel(rtapi_parport_t *t,
                                                 unsigned long v)
{
    (void)t;
    (void)v;
...
#ifdef __KERNEL__
static int rtapi_parport_get(const char *name,
                             ...
                             unsigned int modes)
{
    ...
    if (linux_port) {
        ...
        rtapi_print_msg(
            ...
            linux_port->base,
            linux_port->base_hi);
        port->linux_dev = parport_register_device(
            linux_port, name, NULL, NULL, NULL, 0, NULL);
        ...
        if (linux_port->base_hi > 0) {
            ...
            if (port->region_hi) {
                ...
                rtapi_print_msg(
                    RTAPI_MSG_DBG,
                    "PARPORT: DEBUG: did not get requested region starting at "
                    "0x%x",
                    base_hi);
            }
        }
...
static void rtapi_parport_release(rtapi_parport_t *port)
{
    if (port->linux_dev) {
        rtapi_print_msg(
            ...
            port->linux_dev->port->base,
            port->linux_dev->port->base_hi);
