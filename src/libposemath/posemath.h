...
/* The C++ interface lives in posemath.hh.  Including it here keeps C++ code
   that includes posemath.h working as it did when both were one file. */
#ifdef __cplusplus
#include "posemath.hh"
#endif
