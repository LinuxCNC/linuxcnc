...
int main (int argc, char *argv[ ])
{
    ...
    case 2:
	msg.msglevel = MsgLevel_RTAPI_MSG_ERR;
	strcpy(msg.format, "all manual");
	msg.arg_count = 0;
	break;

    case 3:
	pbprintf(&msg, MsgLevel_RTAPI_MSG_ERR,
		 "no format specifier here\n");
	break;

    case 4:
	pbprintf(&msg, MsgLevel_RTAPI_MSG_WARN,
