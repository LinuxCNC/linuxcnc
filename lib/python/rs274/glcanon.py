...
class GLCanon(gcode.RendererCanon):
    ...
    def __init__(self, colors, geometry, is_foam=0, foam_w=1.5, foam_z=0.0):
        ...
        self.min_extents = [DBL_MAX] * 3
        self.max_extents = [-DBL_MAX] * 3
        self.min_extents_notool = [DBL_MAX] * 3
        self.max_extents_notool = [-DBL_MAX] * 3
        ...
        self.min_extents_zero_rxy = [DBL_MAX] * 3
        self.max_extents_zero_rxy = [-DBL_MAX] * 3
        self.min_extents_notool_zero_rxy = [DBL_MAX] * 3
        self.max_extents_notool_zero_rxy = [-DBL_MAX] * 3
        self.colors = colors
    ...
    def comment(self, arg):
        ...
        ``stop`` aborts the parse by raising, so it is raised from here.
        """
        if arg.startswith("WORKPIECE,"):
            # Recorded even under (AXIS,hide): hide suppresses moves, and the
            # stock is not a move.
    ...
    def calc_extents(self):
        ...
        # to prevent passing the very large [DBL_MAX] * 3 values and populating the gcode properties with
