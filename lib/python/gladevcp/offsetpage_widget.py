...
class OffsetPage(Gtk.Box):
    ...
    def reload_offsets(self):
        g28, g30, g54, g55, g56, g57, g58, g59, g59_1, g59_2, g59_3 = self.read_file()
        if g54 == None: return
    ...
    def read_file(self):
        try:
            ...
            if self.filename == None:
                return g28, g30, g54, g55, g56, g57, g58, g59, g59_1, g59_2, g59_3
    ...
    def set_editing(self, widget):
        ...
        # Set rows editable
        for i in range(1, 13):
            if not self.store[i][0] in('G92', 'G54', 'G55', 'G56', 'G57', 'G58', 'G59', 'G59.1', 'G59.2', 'G59.3'): continue
