...
class ScreenOptions(QtWidgets.QWidget, _HalWidgetBase):
    ...
    def reset_blurList(self):
        self.__blurList = []
    focusBlurList = QtCore.pyqtProperty(.typeToName(.StringList), get_blurList, set_blurList, reset_blurList)
    ...
    def reset_tintList(self):
        self.__tintList = []
    focusTintList = QtCore.pyqtProperty(.typeToName(.StringList), get_tintList, set_tintList, reset_tintList)
