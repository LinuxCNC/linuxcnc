...
try:
    ...
    print("Error in loading Enviroment Variables: {}".format(e))
...
class Aux_program_loader:
    ...
    def keyboard_onboard(self, args="", width="", height=""):
        try:
            ...
            print("Exception in keyboard_onboard: {}".format(e))
            return False
