...
def widgets(P, W):
    ...
    W.bLeft = QRadioButton('Bottom Left')
    ...
    ra = ['ctLabel', 'koLabel', 'osLabel', 'xsLabel', 'xsEntry', \
          'ysLabel', 'ysEntry', 'liLabel', 'liEntry', 'loLabel', 'loEntry', 'dLabel', 'dEntry', 'ocLabel', 'ocEntry']
    ca = ['lDesc']
    ...
    W.xsEntry.editingFinished.connect(lambda:auto_preview(P, W))
    W.ysEntry.editingFinished.connect(lambda:auto_preview(P, W))
    W.liEntry.editingFinished.connect(lambda:auto_preview(P, W))
    W.loEntry.editingFinished.connect(lambda:auto_preview(P, W))
    W.dEntry.editingFinished.connect(lambda:auto_preview(P, W))
    W.ocEntry.editingFinished.connect(lambda:auto_preview(P, W))
    W.xsEntry.textChanged.connect(lambda:entry_changed(P, W, 'xsEntry'))
    W.ysEntry.textChanged.connect(lambda:entry_changed(P, W, 'ysEntry'))
    W.liEntry.textChanged.connect(lambda:entry_changed(P, W, 'liEntry'))
    W.loEntry.textChanged.connect(lambda:entry_changed(P, W, 'loEntry'))
    W.dEntry.textChanged.connect(lambda:entry_changed(P, W, 'dEntry'))
    W.ocEntry.textChanged.connect(lambda:entry_changed(P, W, 'ocEntry'))
