...
def conv_widgets(P, W):
    ...
    W.overcut.setFocusPolicy(Qt.NoFocus)
    W.overcut.setEnabled(False)
    ...
    W.add.setFocusPolicy(Qt.NoFocus)
    W.lDesc = QLabel('')
    W.iLabel = QLabel()
    ...
    W.mirror.setFocusPolicy(Qt.NoFocus)
    W.flip = QPushButton(_translate('Conversational', 'FLIP'))
    W.flip.setFocusPolicy(Qt.NoFocus)
    # lines and arcs
    W.lType = QComboBox()
    W.lType.setFocusPolicy(Qt.NoFocus)
    W.label1 = QLabel()
    ...
    W.g23Arc.setFocusPolicy(Qt.NoFocus)
