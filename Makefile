...
install_modules:
	...
	cp -R rtlib/*.o $(DESTDIR)$(moduledir)
	cp scripts/.runinfo $(DESTDIR)$(moduledir)
	@ echo "kernel modules installed"

install_configs:
	install -d $(DESTDIR)$(sysconfdir)
	cp configs/*.hal $(DESTDIR)$(sysconfdir)
	cp configs/TkEmc $(DESTDIR)$(sysconfdir)
	cp configs/*.ini configs/*.var configs/*.nml $(DESTDIR)$(sysconfdir)
	@ echo "configs installed"

install_bin:
	install -d $(DESTDIR)$(bindir)
	cp -R bin/* $(DESTDIR)$(bindir)
	cp scripts/emc.run $(DESTDIR)$(bindir)
	@ echo "bin installed"
...
install_ncfiles:
	...
	#cp -R nc_files/* $(DESTDIR)$(ncfilesdir)
	@ echo "nc_files installed"

install_tcl:
	install -d $(DESTDIR)$(tcldir)
	cp -R tcl/* $(DESTDIR)$(tcldir)
	@ echo "tcl installed"
