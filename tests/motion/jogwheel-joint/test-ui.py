...
h.newpin("joint-0-jog-counts", hal.HAL_S32, hal.Dir.OUT)
...
h.newpin("joint-1-jog-counts", hal.HAL_S32, hal.Dir.OUT)
...
h.newpin("joint-2-jog-counts", hal.HAL_S32, hal.Dir.OUT)
