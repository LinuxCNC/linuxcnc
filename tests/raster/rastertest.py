...
def main():
    try:
        ...
        pin = {
            ...
            'bpp': c.newpin("bpp", hal.HAL_S32, hal.Dir.IN),
            'ppu': c.newpin("ppu", hal.Type.REAL, hal.Dir.IN),
            'count': c.newpin("count", hal.HAL_S32, hal.Dir.IN),
            'fault': c.newpin("fault", hal.Type.BOOL, hal.Dir.IN),
            'fault_code': c.newpin("fault-code", hal.HAL_S32, hal.Dir.IN),
            'state': c.newpin("state", hal.HAL_S32, hal.Dir.IN),
            'bitmap_position': c.newpin("bitmap-position", hal.Type.REAL, hal.Dir.IN),
            'current_pixel_index': c.newpin("current-pixel-index", hal.HAL_S32, hal.Dir.IN),
