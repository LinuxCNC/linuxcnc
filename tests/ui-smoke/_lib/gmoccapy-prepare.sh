...
# Fix the config-relative PROGRAM_PREFIX: from the /tmp mirror it
# resolves nowhere and iconview throws on every repopulate.
sed -i "s|^PROGRAM_PREFIX = ../../nc_files/|PROGRAM_PREFIX = $SRC_DIR/../../../nc_files|" \
    "$WORK_DIR/gmoccapy.ini"
