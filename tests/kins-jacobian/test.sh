...
run "maxkins" \
    ...
    "joints=9 r1=4 r2=5 base=10,20,30,0,0,0,7,0,3"
...
# against its forward only; pumakins and three21kins answer from their
# Denavit-Hartenberg chain and both checks prove the answer.
