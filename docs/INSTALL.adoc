...
installed. LinuxCNC uses *RT-PREEMPT* (also known as *PREEMPT_RT*) for
realtime operation. If you don't have an RT-PREEMPT kernel installed,
you cannot run LinuxCNC to control any machines. Please refer to the
documentation for information on installing an RT-PREEMPT kernel.
