...
Dans le fichier _custom.hal_ ou dans un fichier jog.hal, ajouter ce qui suit en vérifiant bien que les composants _mux4_ ou _encoder_ ne
...
le numéro de référence. Les composants mux4 et encoder sont décrits dans le manuel de HAL et dans les man pages.
