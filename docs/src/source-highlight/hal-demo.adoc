...
net tool-change manualtoolchange.56.change <= motion.digital-out-01
net tool-changed manualtoolchange.changed motion.digital-in-01
net tool-prep-number manualtoolchange.number f2s32.out
