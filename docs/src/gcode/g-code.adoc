...
* _`G91.1`_ - incremental distance mode for I, J & K offsets.
...
* _`G92.1`_ - turn off G92 offsets and reset <<sub:numbered-parameters,parameters>> 5211 - 5219 to zero.
* _`G92.2`_ - turn off G92 offsets but keep <<sub:numbered-parameters,parameters>> 5211 - 5219 available.
