...
offset and switches back to identity kinematics.
...
they do not switch and blend normally, and a plain 'G43', 'G43.1' or
'G43.2' never switches, whatever kinematics is selected.
...
kinematics, the cancel for the switch 'G43.4' makes. A module that
declares no identity kinematics gets the plain cancel.
