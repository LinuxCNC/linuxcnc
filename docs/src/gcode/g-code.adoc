...
|<<gcode:g28.5,G28.5 G30.5>>       |Go to Predefined Slide Position
...
position too. <<gcode:g28.5,G28.5>> is the form that moves the slides.
...
[[gcode:g28.5]]
== G28.5, G30.5 Go to Predefined Slide Position(((G28.5 Go to Predefined Slide Position)))
...
while the identity kinematics is in force, where the world is that frame.
