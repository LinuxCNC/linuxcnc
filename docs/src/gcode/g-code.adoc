...
|<<gcode:g96-g97,G96 G97>>          |Spindle Control Mode, Constant Surface/Rotation Speed (IPM or m/min / RPM)
...
Thread entries and exits can be programmed tapered with the of 'E'
and 'L' values.
