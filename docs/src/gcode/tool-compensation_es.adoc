...
está en la <<sub:ini:sec:emcio,Sección EMCIO>> del capítulo INI.
...
.Punto final de compensación(((Punto final de compensación)))
...
[[cap:entry-move]]
.Movimiento de entrada
image::images/comp02_en.svg["Movimiento de entrada",align="center"]
