...
== G84 Cycle de taraudage à droite[[sec:G84-Taraudage-a-droite]](((G84 Cycle de taraudage)))
...
== G85 Cycle d'alésage, sans temporisation, retrait en vitesse travail[[sec:G85-Alesage-retrait-travail]](((G85 Cycle d'alésage)))
