...
* '#<_x>' - Return current relative X coordinate including all offsets.
...
In particular, tolerances checks of arcs are done for .001 and .0001
depending on active units
...
the axes to be moved and because the quantity of material removed does
