...
[[cha:plasma-primer]]
= Basicos del Corte por Plasma para Usuarios de LinuxCNC(((Basicos del Corte por Plasma)))
...
Para obtener más información sobre las compensaciones externas (para V 2.8 y superior), lea la <<sub:ini:sec:axis-letter,Seccion [AXIS_<letter>]>> del documento del archivo INI y <<cha:external-offsets,Offsets externos>> en la documentación de Linuxcnc.
