 ...
 * *[AXIS_Z] MIN_LIMIT* should be just below top of the slats with
   ...
   minimum to 5mm (0.197") plus an allowance for overrun (either calculated
...
. Click the first line of the G-Code program in the G-Code display - this method will cancel a selection of either a cut line in the preview window, or a G-Code line in the G-Code window.
