...
It is possible to add a custom message to the warning by editing the <<qt_exit-warning, EXIT WARNING MESSAGE>>.
...
The QtPlasmaC GUI offers user buttons that can be customized by adding commands in the <<qt_button_entries, USER BUTTON ENTRIES>> section of the <<qt_settings-tab, SETTINGS Tab>>.
