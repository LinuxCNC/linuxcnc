...
The resistance can be calculated using R = U__s__ / (I__m__ - I__i__) where:

- R = calculated resistance
- U__s__ = supply voltage
- I__m__ = minimum current required
- I__i__ = input current
...
The power dissipation can by calculated using P = U__s__^2^ / R__s__ where:

- P = power
- U__s__ = supply voltage
- R__s__ = selected resistance
