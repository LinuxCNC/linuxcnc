...
This graph was prepared from a sample of about 16,000 readings at varying cut height and the regression analysis shows 7.53&thinsp;V/mm with 99.4% confidence.
In this particular instance this sample was taken from an Everlast 50&thinsp;A machine being controlled by LinuxCNC.

Torch voltage then becomes an ideal process control variable to use to adjust the cut height.
Let's assume for simplicity that voltage changes by 10&thinsp;V/mm.
This can be restated to be 1&thinsp;Volt per 0.1&thinsp;mm (0.004").
...
* If you have a voltage divider, install a THCAD-10 in your control panel. We've had no problems with this configuration with a 120&thinsp;A Thermal Dynamics plasma cutter.
...
Ideally, for plasma machines a distance of around 15-25&thinsp;mm per motor revolution is considered ideal but even around 30&thinsp;mm per revolutions is still acceptable.
A 5&thinsp;mm pitch ball screw with a 3:1 or 5:1 reduction drive is ideal for the Z axis.
