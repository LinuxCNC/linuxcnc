...
Latency describes the difference between the time that the system is scheduled to perform and action and the time that it actually does perform the action.
