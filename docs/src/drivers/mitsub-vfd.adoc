...
This is a non-realtime HAL program, written in Python, to control VFD's from
Mitsubishi. +
...
[NOTE]
Since this is a non-realtime program it can be affected by computer loading and
