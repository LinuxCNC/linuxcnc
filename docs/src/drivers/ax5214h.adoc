...
WARNING: This driver is deprecated and will be removed in a future
release. It is only built for RTAI kernels; it is not available in the
standard preempt-rt (uspace) builds. If you still use this hardware,
let us know on the LinuxCNC forum or the emc-developers mailing list,
