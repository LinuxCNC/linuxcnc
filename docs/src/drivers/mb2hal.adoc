...
. One option is to create a HAL component as a driver see http://wiki.linuxcnc.org/cgi-bin/wiki.pl?VFD_Modbus[VFD Modbus].
...
* You have more than one device to connect. Mb2hal is very efficient managing multiple devices, transactions and links.
