...
MB2HAL is a generic userspace HAL component to communicate with one or
more Modbus devices.
...
. Set component name (optional) +
  Default `HAL_MODULE_NAME=mb2hal`
+
----
set `HAL_MODULE_NAME=mymodule`
----
+
...
[options="header",cols="12,8,13,70"]
|=======================
...
* 0x07 - NEGATIVE_ACKNOWLEDGE    - Unsuccessful programming request
