...
* 'hal_gpio.rset' - Only exported if there are pins defined in the reset list. This should be placed after the "write" function, and should be in the same thread.
