...
* '_<name>_.DC-bus-volts' (real, out) DC bus voltage of the VFD
* '_<name>_.at-speed' (bool, out) when drive is at commanded speed
* '_<name>_.err-reset' (bool, in) reset errors sent to VFD
* '_<name>_.firmware-revision' (sint, out) from the VFD
* '_<name>_.frequency-command' (real, out) from the VFD
* '_<name>_.frequency-out' (real, out) from the VFD
* '_<name>_.is-stopped' (bool, out) when the VFD reports 0 Hz output
* '_<name>_.load-percentage' (real, out) from the VFD
* '_<name>_.motor-RPM' (real, out) from the VFD
* '_<name>_.output-current' (real, out) from the VFD
* '_<name>_.output-voltage' (real, out) from the VFD
* '_<name>_.power-factor' (real, out) from the VFD
* '_<name>_.scale-frequency' (real, out) from the VFD
* '_<name>_.speed-command' (real, in) speed sent to VFD in RPM
  It is an error to send a speed faster than the Motor Max RPM as set in the VFD.
* '_<name>_.spindle-fwd' (bool, in) 1 for FWD and 0 for REV sent to VFD
* '_<name>_.spindle-rev' (bool, in) 1 for REV and 0 if off
* '_<name>_.spindle-on' (bool, in) 1 for ON and 0 for OFF sent to VFD
* '_<name>_.status-1' (sint, out) Drive Status of the VFD (see the GS2 manual)
* '_<name>_.status-2' (sint, out) Drive Status of the VFD (see the GS2 manual)
...
* '_<name>_.error-count' (sint, RW)
* '_<name>_.loop-time' (real, RW) how often the modbus is polled (default: 0.1)
* '_<name>_.nameplate-HZ' (real, RW) Nameplate Hz of motor (default: 60)
* '_<name>_.nameplate-RPM' (real, RW) Nameplate RPM of motor (default: 1730)
* '_<name>_.retval' (sint, RW) the return value of an error in HAL
* '_<name>_.tolerance' (sint, RW) speed tolerance (default: 0.01)
* '_<name>_.ack-delay' (sint, RW) number of read/write cycles before checking at-speed (default 2)
