...
* 'pdm_frequency' - (u32, RW) This specifies the PDM frequency, in Hz,
  ...
  For example, setting the pdm_frequency to 2*10^6^ (2&thinsp;MHz) and the duty
...
* 'pwm_frequency' - (u32, RW) This specifies the PWM frequency, in Hz,
  ...
  Frequencies below about 5&thinsp;Hz are not terribly accurate, but above 5&thinsp;Hz
