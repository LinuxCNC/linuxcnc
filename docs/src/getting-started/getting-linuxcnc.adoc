...
Most users will aim for the disk image Intel/AMD PCs, the URL
...
Don't. The latencies are too bad with the default kernel and the PREEMPT_RT (the RT is important) kernel of Debian does not boot on the Pi (as of 1/2024).
