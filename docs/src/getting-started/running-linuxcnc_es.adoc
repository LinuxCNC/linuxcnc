...
Los elementos de 'aplicaciones' son típicamente 1) utilidades que no
requieren iniciar linuxcnc o 2) demostraciones de aplicaciones que
pueden usarse con linuxcnc:
...
image::images/configuration-selector_es.png["Selector de Configuración de LinuxCNC"]
