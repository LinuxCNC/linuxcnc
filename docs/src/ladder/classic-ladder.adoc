...
* `%C`__xx__`.D` - Counter _xx_ done (Boolean, read only)
* `%C`__xx__`.E` - Counter _xx_ empty overflow (Boolean, read only)
* `%C`__xx__`.F` - Counter _xx_ full overflow (Boolean, read only)
* `%C`__xx__`.V` - Counter _xx_ current value (integer, read or write)
* `%C`__xx__`.P` - Counter _xx_ preset (integer, read or write)
