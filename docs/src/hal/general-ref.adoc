...
(bool) parport.<portnum>.pin-<pinnum>-in:: The HAL pin associated with the physical input pin _<pinnum>_ of the db25 connector.

(real) pid.<loopnum>.output:: The PID loop output
...
== HAL General Naming Conventions
...
(((HAL Hardware Driver Naming Conventions)))
...
=== Pins/Parameters names

(((HAL Hardware Driver Pins/Parameters Names)))
...
(((HAL Hardware Driver Function Names)))
