...
These read the lower 32-bit value (truncating!) and write 32-bit (properly sign-extended for the underlying type).
...
The pin is called 'out_' because 'out' is an identifier used in '<rtapi_io.h>'.
