...
_Separate parameters from pins in tree_ lists pins and parameters in separate _Pins_ and _Parameters_ branches of the tree, instead of the combined _Pins & Parameters_ branch.
