...
to make an effective CNC system.
...
tabs for show and watch and settings.
...
Under _Tree View_ you will
find: _Expand All_, _Collapse All_; _Expand Pins_, _Expand Parameters_,
...
of that node. Figure <<fig:halshow-show-tab, Halshow Show Tab>> shows a list exactly like
