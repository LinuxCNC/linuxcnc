...
. load the manualtoolchange component and its UI,
. then send the iocontrol 'tool change' to the manualtoolchange 'change' and
. send the manualtoolchange 'changed' back to the iocontrol 'tool changed'.
...
net tool-change iocontrol.0.tool-change => manualtoolchange.change
net tool-changed iocontrol.0.tool-changed <= manualtoolchange.changed
net external-tool-changed manualtoolchange.change_button <= parport.0.pin-12-in
net tool-number iocontrol.0.tool-prep-number => manualtoolchange.number
