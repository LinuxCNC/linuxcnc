...
.HAL loadusr Syntax and Examples
----
...
.HAL unlinkp syntax and Example
----
unlinkp <pin-name>
...
.HAL `and2` example connecting two inputs to one output
----
loadrt and2 count=1
...
.HAL weighted_sum component loading syntax
----
...
.HAL add `process_wsums` function
----
