...
a period of 1&thinsp;ms (1,000&thinsp;µs or 1,000,000&thinsp;ns):
...
The probe selection dialog will close, and the meter looks something like the
following figure.
...
50 microseconds (µs), and does not support floating point.
...
1.0. It is unlikely that one step per second will give us one inch
