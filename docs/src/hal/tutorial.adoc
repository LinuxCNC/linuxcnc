...
Owner   Type   Dir        Value  Name
     3  real   IN             1  siggen.0.amplitude
     3  bool   OUT        FALSE  siggen.0.clock
     3  real   OUT            0  siggen.0.cosine
     3  real   IN             1  siggen.0.frequency
     3  real   IN             0  siggen.0.offset
     3  real   OUT            0  siggen.0.sawtooth
     3  real   OUT            0  siggen.0.sine
     3  real   OUT            0  siggen.0.square
     3  real   OUT            0  siggen.0.triangle
----
...
Of these pins eight are floating point and one is bool (boolean).
...
Parameters:
Owner   Type  Dir        Value   Name
     3  sint  RO             0   siggen.0.update.time
     3  sint  RW             0   siggen.0.update.tmax
----
...
Owner   Type  Dir         Value  Name
     3  real  IN              1  siggen.0.amplitude
     3  bool  OUT         FALSE  siggen.0.clock
     3  real  OUT    -0.1640929  siggen.0.cosine
     3  real  IN              1  siggen.0.frequency
     3  real  IN              0  siggen.0.offset
     3  real  OUT    -0.4475303  siggen.0.sawtooth
     3  real  OUT     0.9864449  siggen.0.sine
     3  real  OUT            -1  siggen.0.square
     3  real  OUT    -0.1049393  siggen.0.triangle
----
...
Owner   Type  Dir         Value  Name
     3  real  IN              1  siggen.0.amplitude
     3  bool  OUT         FALSE  siggen.0.clock
     3  real  OUT     0.0507619  siggen.0.cosine
     3  real  IN              1  siggen.0.frequency
     3  real  IN              0  siggen.0.offset
     3  real  OUT     -0.516165  siggen.0.sawtooth
     3  real  OUT     0.9987108  siggen.0.sine
     3  real  OUT            -1  siggen.0.square
     3  real  OUT    0.03232994  siggen.0.triangle
----
...
Parameters:
Owner   Type  Dir         Value  Name
     3  sint  RO           1754  siggen.0.update.time
     3  sint  RW          16997  siggen.0.update.tmax

halcmd: show pin

Component Pins:
Owner   Type  Dir         Value  Name
     3  real  IN              5  siggen.0.amplitude
     3  bool  OUT         FALSE  siggen.0.clock
     3  real  OUT     0.8515425  siggen.0.cosine
     3  real  IN              1  siggen.0.frequency
     3  real  IN              0  siggen.0.offset
     3  real  OUT      2.772382  siggen.0.sawtooth
     3  real  OUT     -4.926954  siggen.0.sine
     3  real  OUT             5  siggen.0.square
     3  real  OUT      0.544764  siggen.0.triangle
----
...
Component Pins:
Owner   Type  Dir         Value  Name
     4  real  IN              1  siggen.0.amplitude
     4  bool  OUT         FALSE  siggen.0.clock
     4  real  OUT             0  siggen.0.cosine
     4  real  IN              1  siggen.0.frequency
     4  real  IN              0  siggen.0.offset
     4  real  OUT             0  siggen.0.sawtooth
     4  real  OUT             0  siggen.0.sine
     4  real  OUT             0  siggen.0.square
     4  real  OUT             0  siggen.0.triangle
     3  sint  OUT             0  stepgen.0.counts
     3  bool  OUT         FALSE  stepgen.0.dir
     3  bool  IN          FALSE  stepgen.0.enable
     3  real  OUT             0  stepgen.0.position-fb
     3  bool  OUT         FALSE  stepgen.0.step
     3  real  IN              0  stepgen.0.velocity-cmd
     3  sint  OUT             0  stepgen.1.counts
     3  bool  OUT         FALSE  stepgen.1.dir
     3  bool  IN          FALSE  stepgen.1.enable
     3  real  OUT             0  stepgen.1.position-fb
     3  bool  OUT         FALSE  stepgen.1.step
     3  real  IN              0  stepgen.1.velocity-cmd

halcmd: show param

Parameters:
Owner   Type  Dir         Value  Name
     4  sint  RO              0  siggen.0.update.time
     4  sint  RW              0  siggen.0.update.tmax
     3  uint  RW     0x00000001  stepgen.0.dirhold
     3  uint  RW     0x00000001  stepgen.0.dirsetup
     3  real  RO              0  stepgen.0.frequency
     3  real  RW              0  stepgen.0.maxaccel
     3  real  RW              0  stepgen.0.maxvel
     3  real  RW              1  stepgen.0.position-scale
     3  sint  RO              0  stepgen.0.rawcounts
     3  uint  RW     0x00000001  stepgen.0.steplen
     3  uint  RW     0x00000001  stepgen.0.stepspace
     3  uint  RW     0x00000001  stepgen.1.dirhold
     3  uint  RW     0x00000001  stepgen.1.dirsetup
     3  real  RO              0  stepgen.1.frequency
     3  real  RW              0  stepgen.1.maxaccel
     3  real  RW              0  stepgen.1.maxvel
     3  real  RW              1  stepgen.1.position-scale
     3  sint  RO              0  stepgen.1.rawcounts
     3  uint  RW     0x00000001  stepgen.1.steplen
     3  uint  RW     0x00000001  stepgen.1.stepspace
     3  sint  RO              0  stepgen.capture-position.time
     3  sint  RW              0  stepgen.capture-position.tmax
     3  sint  RO              0  stepgen.make-pulses.time
     3  sint  RW              0  stepgen.make-pulses.tmax
     3  sint  RO              0  stepgen.update-freq.time
     3  sint  RW              0  stepgen.update-freq.tmax
----
