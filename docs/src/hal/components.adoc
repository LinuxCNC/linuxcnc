...
----
man axis (or perhaps 'man _<n>_ axis' if your system requires it. _n_ = 1 for userspace and 9 for realtime components)
----
...
For example, if you have a base period of 100,000&thinsp;ns that is 0.0001 seconds and the formula would be 1/(0.0001 x 2) = 5,000&thinsp;Hz or 5&thinsp;kHz. ||
