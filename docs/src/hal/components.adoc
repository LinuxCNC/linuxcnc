...
[{tab_options}]
|===
| link:../man/man9/abs_sint.9.html[abs_sint] |Computes the absolute value and sign of a integer input signal ||
| link:../man/man9/abs.9.html[abs]           |Computes the absolute value and sign of a real input signal ||
...
| link:../man/man9/knob2float.9.html[knob2float] |Converts counts (probably from an encoder) to a real value. ||
...
| link:../man/man9/scaled_sint_sums.9.html[scaled_sint_sums] |Sum of four inputs (each with a scale)  ||
