...
la man page d'Axis. Ou peut être _man 1 axis_, si le système exige le N° de section des man pages.
...
limit1:: (((limit1)))Limite le signal de sortie pour qu'il soit entre min
  et max.  footnote:[Lorsque l'entrée est une position, cela signifie que la _position_ est limitée.]
...
limit3:: (((limit3)))Limite le signal de sortie pour qu'il soit entre min
  ...
  footnote:[Lorsque l'entrée est une position, cela signifie que la _position_, la _vitesse_ et l'_accélération_ sont limitées.]
...
tristate_float:: (((tristate_float))) lace un signal sur une pin d'I/O seulement
  quand elle est validée, similaire à un tampon trois états en électronique.
