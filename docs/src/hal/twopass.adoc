...
This section describes an option to use names not numbers to distinguish multiple occurences of a single module in a HAL file.
...
To recall, LinuxCNC configuration files are specified in a LinuxCNC INI file as [LinuxCNC]HALFILE=filename.
