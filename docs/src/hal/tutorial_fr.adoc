...
[[cha:Tutoriel-HAL]]
= Le tutoriel de HAL(((Tutoriel de HAL)))
...
[[cap:halmeter-Fenetre-selection]](((Fenêtre de sélection)))
...
[[sec:halmeter-valeur]](((Affichage de la valeur)))
...
[[fig:fonction-non-liee]](((Fonction non liée)))
...
[[fig:Fenetre-initiale-halscope]](((Fenêtre initiale)))
...
[[fig:Capture-onde-halscope]](((Capture d'onde)))
.Capture d'ondes
...
[[cap:Ajustement-vertical-halscope]](((Ajustement vertical)))
.Ajustement vertical
...
[[fig:halscope-demo-7]](((Choix d'échantillonnage)))
