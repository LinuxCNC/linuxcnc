...
The user may query HAL in vatious ways to gain information about its state, which then also represents the state of the machine.
...
and compare that desired state with the state the machine is in at the current moment.
