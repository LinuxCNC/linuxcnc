...
are not in the conventional order still gets working spellings.  The
...
kinstype may be declared identity, at most one primary and at most one
machine frame, and declaring a kinstype the module does not provide
