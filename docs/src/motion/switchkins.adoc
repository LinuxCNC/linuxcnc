...
as source: switchkins.c and kins_util.c are installed beside the
headers, in share/linuxcnc, and halcompile already looks there.  With
...
kinematics.h).  A kinstype has to come from one route or the
