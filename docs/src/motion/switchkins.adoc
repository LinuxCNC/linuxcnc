...
kinematics.  Which kinstype is identity is declared by the module (see
Code Notes), not fixed to a number:
...
A module that declares no identity kinstype refuses 'G13.1' with an
