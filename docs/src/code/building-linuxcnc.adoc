...
You want to compile LinuxCNC yourself for The exchange of new developments,
or you may be porting LinuxCNC to some new Linux disribution
or developer reacts to you reporting a problem that you want to test
but any such change will see no buildbot to help, or that help is delayed,
...
a "FIXME: with a comment" in the text as a reference for your self
