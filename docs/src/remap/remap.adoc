...
`namedparams`::
  Python funtcions int this module extend or redefine the namespace of predefined named parameters,
...
`"a message text"`::
  ...
  abort the program'. Works like ``(abort, ``__msg__``)``.
...
http://pydev.org/manual_adv_remote_debugger.html[remote debugging feature].
