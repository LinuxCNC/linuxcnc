...
words are executed in a predefined <<gcode:order-of-execution, order of
...
<<remap:axis-preview-and-remapped-code-execution,evaluating
'self.task'>>.
...
the conditions outlined under <<gcode:canned-cycle-errors,Canned Cycle
Errors>>.
