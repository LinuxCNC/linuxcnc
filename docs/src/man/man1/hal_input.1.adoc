...
**input.**_N_**.btn-**_name_ bool out

**input.**_N_**.btn-**_name_**-not** bool out::
...
**input.**_N_**.abs-**_name_**-counts** sint out

**input.**_N_**.abs-**_name_**-position** real out

**input.**_N_**.abs-**_name_**-scale** parameter real rw

**input.**_N_**.abs-**_name_**-offset** parameter real rw

**input.**_N_**.abs-**_name_**-fuzz** parameter sint rw

**input.**_N_**.abs-**_name_**-flat** parameter sint rw

**input.**_N_**.abs-**_name_**-min** parameter sint r

**input.**_N_**.abs-**_name_**-max** parameter sint r::
...
**input.**_N_**.rel-**_name_**-counts** sint out

**input.**_N_**.rel-**_name_**-position** real out

**input.**_N_**.rel-**_name_**-reset** bool in

**input.**_N_**.rel-**_name_**-scale** parameter real rw

**input.**_N_**.rel-**_name_**-absolute** parameter sint rw

**input.**_N_**.rel-**_name_**-precision** parameter sint rw

**input.**_N_**.rel-**_name_**-last** parameter sint rw::
...
**input.**_N_**.led-**_name_ bool out

**input.**_N_**.led-**_name_**-invert** parameter bool rw::
