...
new-style spelling, for example *out_s32* -> *out_si32* or
*conv_s32_float* -> *conv_si32_real*.  The component name is the
...
applied, how many constructs were left for manual review, and how many
names mention a legacy type (optional rename); if nothing needed to be
