...
*halui.mist.is-on* bool out::
  pin for mist is on
*halui.mist.off* bool in::
  pin for stopping mist
*halui.mist.on* bool in::
  pin for starting mist

=== Max-velocity

*halui.max-velocity.count-enable* bool in (default: *TRUE*)::
  When True, modify max velocity when halui.max-velocity.counts changes.
*halui.max-velocity.counts* sint in::
  ...
  ignores this pin.
*halui.max-velocity.direct-value* bool in::
...
*halui.max-velocity.increase* bool in::
...
**halui.axis.**_L_**.select** bool in::
  pin for selecting axis by letter
**halui.axis.**_L_**.is-selected** bool out::
  status pin that axis _L_ is selected
**halui.axis.**_L_**.pos-commanded** real out::
  Commanded axis position in machine coordinates
**halui.axis.**_L_**.pos-feedback** real out::
  Feedback axis position in machine coordinates
**halui.axis.**_L_**.pos-relative** real out::
