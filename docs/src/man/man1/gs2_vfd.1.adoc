...
<name>.firmware-revision (sint, out)::
  from the VFD
...
<name>.load-percentage (real, out)::
  from the VFD

<name>.motor-RPM (real, out)::
  from the VFD

<name>.output-current (real, out)::
  from the VFD

<name>.output-voltage (real, out)::
  from the VFD

<name>.power-factor (real, out)::
  from the VFD

<name>.scale-frequency (real, out)::
  from the VFD
...
<name>.status-1 (sint, out)::
  Drive Status of the VFD (see the GS2 manual)

<name>.status-2 (sint, out)::
