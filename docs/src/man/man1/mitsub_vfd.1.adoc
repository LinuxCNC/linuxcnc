...
__number~1~__:: is the slave number that was set on the VFD. Must be two digits (Parameter 117).
**name~__N__~=__number~N~__**:: can be repeated for multiple VFD's connected together.
