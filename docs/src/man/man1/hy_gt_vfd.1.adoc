...
*hy_gt_vfd.input-terminal* (real, out)::
    The VFD's input terminal register.

*hy_gt_vfd.output-terminal* (real, out)::
    The VFD's output terminal register.

*hy_gt_vfd.AI1* (real, out)::
    The VFD's AI1 register.

*hy_gt_vfd.AI2* (real, out)::
    The VFD's AI2 register.

*hy_gt_vfd.HDI-frequency* (real, out)::
    The VFD's HDI-frequency register.

*hy_gt_vfd.external-counter* (real, out)::
    The VFD's external counter register.

*hy_gt_vfd.fault-info* (real, out)::
...
*hy_gt_vfd.fault-info-code* (uint, out)::
