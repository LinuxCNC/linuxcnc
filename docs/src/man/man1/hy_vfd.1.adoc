...
_<name>_.enable (bool, in)::
  Enable communication from the hy_vfd driver to the VFD.
_<name>_.SetF (real, out)

_<name>_.OutF (real, out)

_<name>_.OutA (real, out)

_<name>_.Rott (real, out)

_<name>_.DCV (real, out)

_<name>_.ACV (real, out)

_<name>_.Cont (real, out)

_<name>_.Tmp (real, out)

_<name>_.spindle-forward (bool, in)

_<name>_.spindle-reverse (bin, in)

_<name>_.spindle-on (bin, in)

_<name>_.CNTR (real, out)

_<name>_.CNST (real, out)

_<name>_.CNST-run (bool, out)

_<name>_.CNST-jog (bool, out)

_<name>_.CNST-command-rf (bool, out)

_<name>_.CNST-running (bool, out)

_<name>_.CNST-jogging (bool, out)

_<name>_.CNST-running-rf (bool, out)

_<name>_.CNST-bracking (bool, out)

_<name>_.CNST-track-start (bool, out)

_<name>_.speed-command (real, in)

_<name>_.spindle-speed-fb (real, out)::
  Current spindle speed as reported by Huanyang VFD (rpm).
_<name>_.spindle-speed-fb-rps (real, out)::
  Current spindle speed as reported by Huanyang VFD (rps).
_<name>_.spindle-at-speed-tolerance (real, in)::
...
_<name>_.spindle-at-speed (bool, out)::
  True when the current spindle speed is within `.spindle-at-speed-tolerance` of the commanded speed.

_<name>_.frequency-command (real, out)

_<name>_.max-freq (real, out)

_<name>_.base-freq (real, out)

_<name>_.freq-lower-limit (real, out)

_<name>_.rated-motor-voltage (real, out)

_<name>_.rated-motor-current (real, out)

_<name>_.rated-motor-rev (real, out)

_<name>_.motor-poles (uint, out)

_<name>_.hycomm-ok (bool, out)

_<name>_.error-count (sint, RO)

_<name>_.retval (uint, RO)
