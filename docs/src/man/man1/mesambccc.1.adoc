...
<commands>
  <command device="wavebox" function="R_COILS" address="0x0000" count="4" name="state" />
    <description>Type is implicit HAL_BOOL, will become HAL pins:
  ...
  <command device="scd30" modbustype="F_ABCD" haltype="HAL_REAL" function="R_REGISTERS"
  ...
  <command device="broadcast" function="W_COILS" address="0x1234" count="2"
    ...
    <description>Will create HAL_BOOL pins:
  ...
  <command delay="10000" />
  <command device="watcher" function="W_REGISTER" haltype="HAL_UINT" modbustype="U_AB"
           address="0x1ee7" noanswer="1" resend="1">
    <pin name="watcher" />
    <description>Will create a HAL_UINT pin
...
<command device="booboo"
  ...
  <pin name="ping" haltype="HAL_BOOL" modbustype="U_AB" />
...
<!--
  ...
  hm2_modbus.0.speed         HAL_REAL (out)
  hm2_modbus.0.ping          HAL_BOOL (out)
  hm2_modbud.0.afloat        HAL_REAL (out)
  hm2_modbud.0.afloat.offset HAL_REAL (in)
  hm2_modbud.0.afloat.scale  HAL_REAL (in)
  hm2_modbud.0.afloat.scaled HAL_REAL (out)
-->
</command>
----
