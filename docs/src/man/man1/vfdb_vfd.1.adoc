...
The vfdb_vfd driver takes precedence over panel control while it is enabled (see _.enable_ pin), effectively disabling the panel.
Clearing the _.enable_ pin re-enables the panel.
