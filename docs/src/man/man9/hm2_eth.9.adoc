...
7I96, 7I96S, 7I97, 7I98. The board must have its firmware loaded on the
board by the mesaflash(1) program.
...
with that technology. This chain contains addtional rules to control
