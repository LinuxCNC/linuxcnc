...
*loadrt motmod [base_period_nsec=*_period_*] [base_thread_fp=*_0 or 1_*]
[servo_period_nsec=*_period_*] [traj_period_nsec=*_period_*]
[num_joints=*_[1-16]_*] [num_dio=*_[1-64]_*] [num_aio=*_[1-64]_*]
[num_misc_error=*_[0-64]_*] [num_spindles=*_[1-8]_*]*
*[unlock_joints_mask=*_jointmask_*]* *[num_extrajoints=*_[0-16]_*]*
...
Pin names starting with "*joint*" or "*axis*" are are read and updated
