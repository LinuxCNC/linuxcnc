...
=== La planification de trajectoire(((Trajectory Planning,TP)))
...
image::images/mill-diagram.png["Configuration typique d'une fraiseuse",align="center"]
...
image::images/lathe-diagram.png["Configuration typique d'un tour",align="center"]
