...
Este documento se centra en el uso de LinuxCNC, más bien, está destinado
a lectores que ya lo han instalado y configurado.
Alguna información sobre la instalación es dado en los capítulos
siguientes.
La documentación completa sobre la instalación y la configuración se
encuentra en el manual del integrador.
...
.Máquina simple controlada por LinuxCNC
...
.Axis, interfaz GUI de teclado estándar
...
.Touchy, una GUI para usar con pantalla táctil
...
.Gscreen, una GUI de pantalla táctil configurable
...
.GMOCCAPY, una GUI de pantalla táctil basada en Gscreen
...
.NGCGUI, una interfaz gráfica integrada en AXIS
image::../gui/images/ngcgui.png["NGCGUI, una interfaz gráfica integrada en AXIS",align="center"]

TkLinuxCNC:: << sec:tklinuxcnc-intro,TkLinuxCNC >>, another interface based on Tcl/Tk.
  Once the most popular interface after AXIS.

[[fig:tklinuxcnc-gui]]
.Interfaz gráfica TkLinuxCNC
image::images/tklinuxcnc_fr.png["Interfaz gráfica TkLinuxCNC",align="center"]
...
.Ejemplo de PyVCP integrado en la GUI de AXIS
image::../gui/images/axis-pyvcp.png["PyVCP integrado en Axis",align="center"]
...
.Ejemplo de GladeVCP integrado en la GUI de AXIS
image::../gui/images/axis-gladevcp.png["GladeVCP integrado en Axis",align="center"]
