...
You will receive updates with the regular Debian packages.
...
http://www.linuxcnc.org/docs/html/gui/gladevcp.html[GladeVCP].
...
GMOCCAPY offers also a HAL pint to output the selected jog increment
