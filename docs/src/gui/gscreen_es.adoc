...
image::images/gscreen-mill.png["Fresadora Based",align="center"]

.Silverdragon
image::images/silverdragon.png["Silverdragon",align="center"]

.Spartan
image::images/spartan.png["Spartan",align="center"]

.Gaxis
image::images/gaxis.png["Gaxis",align="center"]

.Industrial
image::images/industrial.png["Industrial",align="center"]
...
comportamiento personalizado. Las rutinas del handler pueden llamar a las rutinas predeterminadas de Gscreen, ya sea antes o
después de ejecutar su propio código. De esta manera se puede añadir comportamiento extra,
...
image::images/tester.png["Gscreen pantalla utilizable simple",align="center"]
...
. Gscreen comprueba el archivo del controlador para la función de pines ('initialize_pins (self)') o
  bien usar Gscreen stock uno.
