...
* 'halui.gui.cancel' (bit, in) - pin for cancel/closing dialogs
* 'halui.gui.ok' (bit, in) - pin for ok/apply dialogs
* 'halui.gui.mdi-command-MACRO_<nn>_' (bit, in) - pin for calling mdi/macro commands
...
* 'halui.gui.softkey_<nn>_' (bit, in) - pins for screen defined functions
_<nn>_ is a two digit number starting from 00 to 19 + 
