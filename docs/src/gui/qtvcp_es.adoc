...
Removed all-Englush file: qtvcp-libraries,bibliotecas QtVCP

Removed all-English file: cha:qtvcp-code,fragmentos de código de archivo del controlador QtVCP

Removed all-English file: cha:qtvcp-development,QtVCP Development

Removed all-English file: cha:qtvcp-custom-widgets,QtVCP Custom Designer Widgets
