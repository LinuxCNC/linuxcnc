...
'MAIN','FILE','OFFSETS','TOOL','STATUS','PROBE','GCODES','SETUP','SETTINGS','UTILITIES','USER','CAMERA'

also:

- enabling halui.gui.mpg-select.0, will allow zooming/scrolling of the gcode plot or text display with an MPG.
...
Owner   Type  Dir                 Value  Name
    25  bit   IN                  FALSE  halui.gui.cancel
    ...
    25  bit   IN                  FALSE  halui.gui.mdi-command-MACRO4
    25  bit   IN                  FALSE  halui.gui.mdi-command-MACRO5
    25  bit   IN                  FALSE  halui.gui.mpg-select.0
    25  bit   IN                  FALSE  halui.gui.ok
    25  bit   IN                  FALSE  halui.gui.reload-display
