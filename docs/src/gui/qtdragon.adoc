...
- If there are macros defined in the INI, there will be pins available to initiate them. +
...
Set resolution to DEFAULT for opencv to choose. the available resolutions 
will be listed if -V debugging is used. +
