...
The file name qtdragon.pref can be user selected.
...
<<sub:remap:sec:builtin-remaps, Remap INI Details>> +
...
In QtDragon, there is a splitter handle between the gcode text display and the gcode graphical display. +
...
<<sub:qtvcp:widgets:qt-ngcgui,Widgets-NGCGUI>>
...
Change the gcode text display colors/fonts:
