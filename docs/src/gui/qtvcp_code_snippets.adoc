...
Here is how to load and save varibles using Pyqt's QSettings functions: +
...
A statusbar is used for short infomation to show the user. +
 +
...
The messages are also recorded untill the user erases them using controls. +
