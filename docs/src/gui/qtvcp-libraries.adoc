...
def initialized__(self):
    self.pin_button_in = QHAL.newpin('cycle-start-in',QHAL.HAL_BOOL, QHAL.HAL_IN)
...
*_<SCREEN BASENAME>.<PINNAME>_*:: invoking sint pin
*_<SCREEN BASENAME>.<PINNAME>-waiting_*:: 'Waiting for the user's response' output bool pin
*_<SCREEN BASENAME>.<PINNAME>-response_*:: 'The user response' output bool pin
*_<SCREEN BASENAME>.<PINNAME>-response-s32_*:: 'The user response' output sint pin
...
* _defined in the INI file under the `[DISPLAY]` heading_, and
* _controlled by one sint HAL pin per defined id_.
* _each message is called by a corresponding number on the sint pin._
...
*_<SCREEN BASENAME>.<ID NAME>_*:: invoking sint pin
*_<SCREEN BASENAME>.<ID NAME>-waiting_*:: 'Waiting for the user's response' output bool pin
*_<SCREEN BASENAME>.<ID NAME>-response_*:: 'The user response' output bool pin
*_<SCREEN BASENAME>.<ID NAME>-response-s32_*:: 'The user response' output sint pin
