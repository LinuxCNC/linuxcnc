...
+
This array is expected to use the LinuxCNC _raw tool array_, i.e. doesn't have tool wear entries.
+
//FIXME Really ??
...
https://git.yoctoproject.org/matchbox-keyboard/[`Matchbox`] libraries for the keyboard.
