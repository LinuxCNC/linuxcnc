...
[DISPLAY]TKPKG=Ngcgui version_number::
  ...
  _Note_:    Obligatoire, spécifie le chargement des onglets NGCGUI dans AXIS.
...
[DISPLAY]NGCGUI_SUBFILE = subfile_filename::
  ...
  _Note_:    Utilise un ou plusieurs items pour spécifier les fichiers compatibles
...
[DISPLAY]NGCGUI_OPTIONS = opt1 opt2 ...::
  ...
  _Note_:    De multiples options séparées par des espaces.
...
.Alternate Variable Tags Formats Examples
----
//ngcgui: feedrate = 10;
//ngcgui: xl = 0; //, x limit
----
...
.Option line tag format Examples
----
//ngcgui: -I
//ngcgui: --imperial
//ngcgui: --precision 5
