...
[[fig:axis-window]]
.La Ventana de AXIS
image::images/axis_es.png["Ventana Principal AXIS",align="center"]
...
* 'Feed Override' - que le permite escalar la velocidad de los movimientos programados.
  ...
  en el archivo ini. Consulte la <<sub:ini:sec:display, Sección de visualización>> del
...
* 'Jog Speed' - que te permite configurar la velocidad de jog dentro de los límites establecidos en el archivo ini.
  Ver la <<sub:ini:sec:display,Sección de visualización>> del archivo INI para obtener más información.
...
* 'Abrir ...' - abre un cuadro de diálogo estándar para abrir un archivo de código g para cargar en AXIS. Si
  ...
  Consulte la <<sub:ini:sec:filter,sección FILTRO>> de la configuración INI
...
* 'Editar ...' - abre el archivo de código G actual para editarlo si tienes un editor
  configurado en su archivo ini. Consulte la sección <<sub:ini:sec:display,sección DISPLAY>>
...
[[fig:soft-limits]]
.Lìmites Suaves(((Lìmites Suaves)))
image::images/axis-outofrange.png["Lìmites Suaves",align="center"]
...
Consulte la <<sub:ini:sec:display, sección DISPLAY>> para obtener más información sobre la configuración
los incrementos.
...
.Touch Off Window
image::images/touchoff_es.png["Touch Off Window",align="center"]
...
.Atajos de teclado más comunes(((AXIS,Keyboard Shortcuts)))
...
image::images/axis-emc-status_es.png["Ventana de Estado de LinuxCNC",align="center"]
...
.Ventana de cambio de herramientas manual(((AXIS: Ventana de cambio de herramientas manual)))
...
.Modo AXIS para el torno
image::images/axis-lathe-tool.png["Modo AXIS para el torno",align="center"]
...
trabaja, consulte la sección << sub:ini:sec:display,Seccion Display>> del capitulo de configuración INI.
...
Para obtener más información, consulte la sección <<sub:ini:sec:display,Sección display>>
