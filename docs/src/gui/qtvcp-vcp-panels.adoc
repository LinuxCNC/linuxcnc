...
.`vismach_mill_xyz`
3D OpenGL view of a _3 axes milling machine_.
...
.QtVCP `vismach_mill_xyz` - 3 Axes Mill 3D View Panel
image::images/qtvismach.png["QtVCP vismach_mill_xyz - 3 Axes Mill 3D View Panel",align="center"]
...
.`vismach_millturn`
3D OpenGL view of a _3 axes milling machine with an A axis/spindle_.
...
3D OpenGL view of a _5 axes gantry type milling machine_.
...
.QtVCP `vismach_mill_5axis_gantry` - 5 Axes Gantry Mill 3D View Panel
image::images/qtvismach_5axis_gantry.png["QtVCP vismach_mill_5axis_gantry - 5 Axes Gantry Mill 3D View Panel",align="center"]
