...
the absolute position 0 for that axis and will set the 'is-homed' bool for that axis.
...
----
Type  Dir  Name
bool  OUT  axisui.jog.x
bool  OUT  axisui.jog.y
bool  OUT  axisui.jog.z
bool  OUT  axisui.jog.a
bool  OUT  axisui.jog.b
bool  OUT  axisui.jog.c
bool  OUT  axisui.jog.u
bool  OUT  axisui.jog.v
bool  OUT  axisui.jog.w
----
...
----
Type  Dir    Name
bool  IN     axisui.notifications-clear
bool  IN     axisui.notifications-clear-error
bool  IN     axisui.notifications-clear-info
----
