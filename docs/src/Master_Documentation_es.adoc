...
include::gui/qtvcp_es.adoc[]

:leveloffset: 3

//include::gui/qtvcp-vcp-panels_es.adoc[]

//include::gui/qtvcp-widgets_es.adoc[]

//include::gui/qtvcp-libraries_es.adoc[]

//include::gui/qtvcp-vismach_es.adoc[]

//include::gui/qtvcp-custom-widgets_es.adoc[]

//include::gui/qtvcp-code-snippets_es.adoc[]

//include::gui/qtvcp-development_es.adoc[]
...
//include::motion/switchkins_es.adoc[]

include::motion/pid-theory_es.adoc[]

include::motion/external-offsets_es.adoc[]

//include::tooldatabase/tooldatabase_es.adoc[]
