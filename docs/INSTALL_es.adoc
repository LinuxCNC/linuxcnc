...
tiempo real*. LinuxCNC usa *RT-PREEMPT* (también conocido como *PREEMPT_RT*)
para operación en tiempo real. Si no tiene un núcleo RT-PREEMPT instalado,
no puede ejecutar LinuxCNC para controlar ninguna máquina. Por favor
consulte la documentación para información sobre cómo instalar un núcleo
RT-PREEMPT.
