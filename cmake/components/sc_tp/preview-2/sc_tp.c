 ...
 *
 * In ~/linuxcnc/cmake/components/sc_tp/$ ./runtest
 *
 * Or start lcnc with rip-environment, then:
...
param_float_data_t
*tc_progress,             //! where are we in the segment?  0..target
*tc_target,               //! actual segment length
*tc_motiontype,
*tc_canon_motiontype,
*tc_id,                    //! segment's serial number
*tp_exec_id,
*tc_requested_vel,
*tc_currentvel,
*tc_target_vel,
*tc_term_vel,            //! actual velocity at termination of segment
*tc_final_vel,
*tp_x,*tp_y,*tp_z,
*tp_goalpos_x,
*tp_goalpos_y,
...
//! Perforn's every ms.
static void the_function(){
    //  rtapi_print_msg(RTAPI_MSG_NONE," tpGetPos: = %f\n",100);
    *enable->Pin=1;
}
...
static int setup_pins(){
    ...
    //! Param bit rw.
    tc_remove = (param_bit_data_t*)hal_malloc(sizeof(param_bit_data_t));
    r+=hal_param_bit_new("sc-tp.tc_remove",HAL_RW,&(tc_remove->Pin),comp_idx);

    //! Param int rw.
    tp_reverse_run = (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.tp_reverse_run",HAL_RW,&(tp_reverse_run->Pin),comp_idx);

    tp_done = (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.tp_done",HAL_RW,&(tp_done->Pin),comp_idx);

    tp_pausing = (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.tp_pausing",HAL_RW,&(tp_pausing->Pin),comp_idx);

    tp_aborting= (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.tp_aborting",HAL_RW,&(tp_aborting->Pin),comp_idx);

    tp_queue_size= (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.tp_queue_size->size_of_queue_vector",HAL_RW,&(tp_queue_size->Pin),comp_idx);

    tp_depth= (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.tp_depth->nr_total_queued_motions",HAL_RW,&(tp_depth->Pin),comp_idx);

    tc_current_depth = (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.tc_current_depth->nr_motions_blending",HAL_RW,&(tc_current_depth->Pin),comp_idx);

    tc_is_blending = (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.tc_is_blending",HAL_RW,&(tc_is_blending->Pin),comp_idx);

    sc_pvec_size = (param_s32_data_t*)hal_malloc(sizeof(param_s32_data_t));
    r+=hal_param_s32_new("sc-tp.sc_pvec_size",HAL_RW,&(sc_pvec_size->Pin),comp_idx);



    //! Param float rw.
    tc_progress = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tc_progress",HAL_RW,&(tc_progress->Pin),comp_idx);

    tc_target = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tc_target",HAL_RW,&(tc_target->Pin),comp_idx);

    tc_motiontype = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tc_motiontype->1_lin->2_arc->3_tap",HAL_RW,&(tc_motiontype->Pin),comp_idx);

    tc_canon_motiontype = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tc_canon_motiontype->arc_3->lin_2->GO_1",HAL_RW,&(tc_canon_motiontype->Pin),comp_idx);


    tc_id = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tc_id->current_gcodeline",HAL_RW,&(tc_id->Pin),comp_idx);

    tp_exec_id = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tp_exec_id->current_gcode_line_exec",HAL_RW,&(tp_exec_id->Pin),comp_idx);
    ...
    tc_term_vel = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tc_term_vel",HAL_RW,&(tc_term_vel->Pin),comp_idx);

    tc_target_vel = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tc_target_vel",HAL_RW,&(tc_target_vel->Pin),comp_idx);

    tc_final_vel = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tc_final_vel",HAL_RW,&(tc_final_vel->Pin),comp_idx);

    vi = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.vi",HAL_RW,&(vi->Pin),comp_idx);

    si = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.si",HAL_RW,&(si->Pin),comp_idx);

    ai = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.ai",HAL_RW,&(ai->Pin),comp_idx);

    sc_vm = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.sc_vm",HAL_RW,&(sc_vm->Pin),comp_idx);

    sc_a = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.sc_a",HAL_RW,&(sc_a->Pin),comp_idx);

    sc_dv = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.sc_dv",HAL_RW,&(sc_dv->Pin),comp_idx);
    ...
    tp_goalpos_x = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tp_goalpos_x->eof_gcode_pos",HAL_RW,&(tp_goalpos_x->Pin),comp_idx);

    tp_goalpos_y = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tp_goalpos_y->eof_gcode_pos",HAL_RW,&(tp_goalpos_y->Pin),comp_idx);

    tp_goalpos_z = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.tp_goalpos_z->eof_gcode_pos",HAL_RW,&(tp_goalpos_z->Pin),comp_idx);

    dtg = (param_float_data_t*)hal_malloc(sizeof(param_float_data_t));
    r+=hal_param_float_new("sc-tp.dtg",HAL_RW,&(dtg->Pin),comp_idx);
...
STATIC int tcRotaryMotionCheck(TC_STRUCT const * const tc) {
    ...
    case TC_SPHERICAL:
        return true;
    default:
        rtapi_print_msg(RTAPI_MSG_NONE,"Unknown motion type!\n");
        return false;
    }
}
...
STATIC int tpGetMachineActiveLimit(double * const act_limit, PmCartesian const * const bounds) {
    ...
    *act_limit = fmax(fmax(bounds->x,bounds->y),bounds->z);
    ...
    rtapi_print_msg(RTAPI_MSG_NONE," arc blending a_max=%f\n", *act_limit);
    return TP_ERR_OK;
}
...
STATIC double tpGetFeedScale(TP_STRUCT const * const tp,
    ...
    if (pausing)  {
        ...
        tc_is_blending->Pin=tc->is_blending;
...
int tpCreate(TP_STRUCT * const tp, int _queueSize,int id)
{
    ...
    tp_queue_size->Pin=tp->queueSize;
...
int tpSetId(TP_STRUCT * const tp, int id)
{
    ...
    if (!MOTION_ID_VALID(id)) {
        rtapi_print_msg(RTAPI_MSG_NONE, "tpSetId: invalid motion id %d\n", id);
        return TP_ERR_FAIL;
    }
...
int tpSetCurrentPos(TP_STRUCT * const tp, EmcPose const * const pos)
{
    ...
    if (emcPoseValid(pos)) {
        ...
        rtapi_print_msg(RTAPI_MSG_NONE, "Tried to set invalid pose in tpSetCurrentPos on id %d!"
                "pos is %.12g, %.12g, %.12g\n",
                        tp->execId,
                        pos->tran.x,
                        pos->tran.y,
...
int tpAddCurrentPos(TP_STRUCT * const tp, EmcPose const * const disp)
{
    ...
    if (emcPoseValid(disp)) {
        ...
        rtapi_print_msg(RTAPI_MSG_NONE, "Tried to set invalid pose in tpAddCurrentPos on id %d!"
                "disp is %.12g, %.12g, %.12g\n",
                        tp->execId,
                        disp->tran.x,
                        disp->tran.y,
...
int tpErrorCheck(TP_STRUCT const * const tp) {
    ...
    if (!tp) {
        rtapi_print_msg(RTAPI_MSG_NONE, "TP is null\n");
        return TP_ERR_FAIL;
    }
    if (tp->aborting) {
        rtapi_print_msg(RTAPI_MSG_NONE, "TP is aborting\n");
        return TP_ERR_FAIL;
    }
    return TP_ERR_OK;
}
                                  ...
                                  double acc)
{
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"blend tc length = %f\n",length);
...
STATIC int tcSetLineXYZ(TC_STRUCT * const tc, PmCartLine const * const line)
{
    ...
    if (!tc->coords.line.abc.tmag_zero || !tc->coords.line.uvw.tmag_zero) {
        rtapi_print_msg(RTAPI_MSG_NONE, "SetLineXYZ does not supportABC or UVW motion\n");
        return TP_ERR_FAIL;
    }
                                         ...
                                         TC_STRUCT * const blend_tc)
{
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"Blend performance: parabolic %f, tangent %f, arc_blend %f, ",
                    perf_parabolic,
                    perf_tangent,
                    perf_arc_blend);
    ...
    case ARC_BLEND: // arc blend
        rtapi_print_msg(RTAPI_MSG_NONE,"using blend arc\n");
        tcRemoveKinkProperties(prev_tc, tc);
...
{
    rtapi_print_msg(RTAPI_MSG_NONE,"-- Starting LineArc blend arc --\n");
    ...
    if (res_init != TP_ERR_OK) {
        rtapi_print_msg(RTAPI_MSG_NONE,"blend init failed with code %d, aborting blend arc\n",
                        res_init);
        return res_init;
    }
    ...
    if (!coplanar) {
        rtapi_print_msg(RTAPI_MSG_NONE,"aborting arc, not coplanar\n");
        return TP_ERR_FAIL;
    }
    ...
    if (res_init || res_param || res_points || res_post) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Got %d, %d, %d, %d for init, param, points, post, aborting arc\n",
                        res_init,
                        res_param,
                        res_points,
                        res_post);
    ...
    if (points_exact.trim2 > param.phi2_max) {
        rtapi_print_msg(RTAPI_MSG_NONE,"trim2 %f > phi2_max %f, aborting arc...\n",
                        points_exact.trim2,
                        param.phi2_max);
        return TP_ERR_FAIL;
    }
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"phi2_new = %f\n",phi2_new);
    int res_stretch2 = pmCircleStretch(&circ2_temp,
                                       phi2_new,
                                       true);
    //TODO create blends
    if (res_stretch1 || res_stretch2) {
        rtapi_print_msg(RTAPI_MSG_NONE,"segment resize failed, aborting arc\n");
        return TP_ERR_FAIL;
    }
    ...
    int res_arc = arcFromBlendPoints3(&blend_tc->coords.arc.xyz,
                                      ...
                                      &param);
    if (res_arc < 0) {
        rtapi_print_msg(RTAPI_MSG_NONE,"arc creation failed, aborting arc\n");
        return TP_ERR_FAIL;
    }
    ...
    if (res_tangent < 0) {
        rtapi_print_msg(RTAPI_MSG_NONE,"failed tangent check, aborting arc...\n");
        return TP_ERR_FAIL;
    }
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"Passed all tests, updating segments\n");
    ...
    if (param.consume) {
        ...
        if (res_pop) {
            rtapi_print_msg(RTAPI_MSG_NONE,"failed to pop segment, aborting arc\n");
            return TP_ERR_FAIL;
        }
    } else {
...
STATIC tp_err_t tpCreateArcLineBlend(TP_STRUCT * const tp, TC_STRUCT * const prev_tc, TC_STRUCT * const tc, TC_STRUCT * const blend_tc)
{
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"-- Starting ArcLine blend arc --\n");
    PmCartesian acc_bound, vel_bound;
    ...
    //Catch errors in blend setup
    if (res_init || res_param || res_points || res_post) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Got %d, %d, %d, %d for init, param, points, post\n",
                        res_init,
                        res_param,
                        res_points,
                        res_post);
    ...
    if (points_exact.trim1 > param.phi1_max) {
        rtapi_print_msg(RTAPI_MSG_NONE,"trim1 %f > phi1_max %f, aborting arc...\n",
                        points_exact.trim1,
                        param.phi1_max);
        return TP_ERR_FAIL;
    }
...
STATIC tp_err_t tpCreateArcArcBlend(TP_STRUCT * const tp, TC_STRUCT * const prev_tc, TC_STRUCT * const tc, TC_STRUCT * const blend_tc)
{
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"-- Starting ArcArc blend arc --\n");
    //TODO type checks
    int colinear = pmUnitCartsColinear(&prev_tc->coords.circle.xyz.normal,
                                       &tc->coords.circle.xyz.normal);
    if (!colinear) {
        // Fail out if not collinear
        rtapi_print_msg(RTAPI_MSG_NONE,"arc abort: not coplanar\n");
        return TP_ERR_FAIL;
    }
    ...
    if (!coplanar1) {
        rtapi_print_msg(RTAPI_MSG_NONE,"aborting blend arc, arc id %d is not coplanar with binormal\n", prev_tc->id);
        return TP_ERR_FAIL;
    }
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"phi1_new = %f, trim1 = %f\n", phi1_new, points_exact.trim1);
    rtapi_print_msg(RTAPI_MSG_NONE,"phi2_new = %f, trim2 = %f\n", phi2_new, points_exact.trim2);
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"Modified arc points\n");
    blendPoints3Print(&points_exact);
    int res_arc = arcFromBlendPoints3(&blend_tc->coords.arc.xyz, &points_exact, &geom, &param);
    if (res_arc < 0) {
        return TP_ERR_FAIL;
                                      ...
                                      TC_STRUCT * const tc, TC_STRUCT * const blend_tc)
{
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"-- Starting LineLine blend arc --\n");
    PmCartesian acc_bound, vel_bound;
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"blend_tc target_vel = %g\n", blend_tc->target_vel);
    ...
    if (param.consume) {
        ...
        if (retval) {
            ...
            rtapi_print_msg(RTAPI_MSG_NONE, "PopBack failed\n");
            return TP_ERR_FAIL;
        }
        ...
        rtapi_print_msg(RTAPI_MSG_NONE,"keeping previous line\n");
...
STATIC inline int tpAddSegmentToQueue(TP_STRUCT * const tp, TC_STRUCT * const tc, int inc_id) {
    ...
    if (tcqPut(&tp->queue, tc) == -1) {
        rtapi_print_msg(RTAPI_MSG_NONE, "tcqPut failed.\n");
        return TP_ERR_FAIL;
    }
    if (inc_id) {
        tp->nextId++;
    ...
    if (tc->motion_type != TC_RIGIDTAP) {
        ...
        tp_goalpos_x->Pin=tp->goalPos.tran.x;
        tp_goalpos_y->Pin=tp->goalPos.tran.y;
        tp_goalpos_z->Pin=tp->goalPos.tran.z;
    }
    tp->done = 0;
    tp->depth = tcqLen(&tp->queue);
    tp_depth->Pin=tp->depth;
    //Fixing issue with duplicate id's?
    rtapi_print_msg(RTAPI_MSG_NONE,"Adding TC id %d of type %d, total length %0.08f\n",tc->id,tc->motion_type,tc->target);
...
STATIC int handleModeChange(TC_STRUCT * const prev_tc, TC_STRUCT * const tc)
{
    ...
    if ((prev_tc->canon_motion_type == EMC_MOTION_TYPE_TRAVERSE) ^
        ...
        rtapi_print_msg(RTAPI_MSG_NONE,"Blending disabled: can't blend between rapid and feed motions\n");
        tcSetTermCond(prev_tc, tc, TC_TERM_COND_STOP);
    }
    if (prev_tc->synchronized != TC_SYNC_POSITION &&
            tc->synchronized == TC_SYNC_POSITION) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Blending disabled: changing spindle sync mode from %d to %d\n",
...
int tpAddRigidTap(TP_STRUCT * const tp,
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"== AddRigidTap ==\n");

    if(!tp->synchronized) {
        rtapi_print_msg(RTAPI_MSG_NONE, "Cannot add unsynchronized rigid tap move.\n");
        return TP_ERR_FAIL;
    }
...
STATIC blend_type_t tpCheckBlendArcType(
    ...
    if (!prev_tc || !tc) {
        rtapi_print_msg(RTAPI_MSG_NONE,"prev_tc or tc doesn't exist\n");
        return BLEND_NONE;
    }

    //If exact stop, we don't compute the arc
    if (prev_tc->term_cond != TC_TERM_COND_PARABOLIC) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Wrong term cond = %u\n", prev_tc->term_cond);
        return BLEND_NONE;
    }

    //If we have any rotary axis motion, then don't create a blend arc
    if (tcRotaryMotionCheck(tc) || tcRotaryMotionCheck(prev_tc)) {
        rtapi_print_msg(RTAPI_MSG_NONE,"One of the segments has rotary motion, aborting blend arc\n");
        return BLEND_NONE;
    }

    if (tc->finalized || prev_tc->finalized) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Can't create blend when segment lengths are finalized\n");
        return BLEND_NONE;
    }

    rtapi_print_msg(RTAPI_MSG_NONE,"Motion types: prev_tc = %u, tc = %u\n",
...
STATIC int tpComputeOptimalVelocity(TP_STRUCT const * const tp, TC_STRUCT * const tc, TC_STRUCT * const prev1_tc) {
    ...
    if (vs_back >= vf_limit ) {
        ...
        rtapi_print_msg(RTAPI_MSG_NONE,"found peak due to v_limit %f\n", vf_limit);
    }
    ...
    rtapi_print_msg(RTAPI_MSG_NONE," prev1_tc-> fv = %f, tc->fv = %f\n",
...
STATIC int tpRunOptimization(TP_STRUCT * const tp) {
    ...
    for (x = 1; x < emcmotConfig->arcBlendOptDepth + 2; ++x) {
        rtapi_print_msg(RTAPI_MSG_NONE,"==== Optimization step %d ====\n",x);
        ...
        if ( !prev1_tc || !tc) {
            rtapi_print_msg(RTAPI_MSG_NONE," Reached end of queue in optimization\n");
            return TP_ERR_OK;
        }
        ...
        if (prev1_tc->term_cond != TC_TERM_COND_TANGENT) {
            if (hit_non_tangent) {
                ...
                rtapi_print_msg(RTAPI_MSG_NONE,"Found 2nd non-tangent segment, stopping optimization\n");
                return TP_ERR_OK;
            } else  {
                rtapi_print_msg(RTAPI_MSG_NONE,"Found first non-tangent segment, contining\n");
        ...
        if (progress_ratio >= cutoff_ratio) {
            rtapi_print_msg(RTAPI_MSG_NONE,"segment %d has moved past %f percent progress, cannot blend safely!\n",
        ...
        if (prev1_tc->splitting || prev1_tc->blending_next) {
            rtapi_print_msg(RTAPI_MSG_NONE,"segment %d is already blending, cannot optimize safely!\n",
                            ind-1);
            return TP_ERR_OK;
        }

        rtapi_print_msg(RTAPI_MSG_NONE,"  current term = %u, type = %u, id = %u, accel_mode = %d\n",
                        tc->term_cond, tc->motion_type, tc->id, tc->accel_mode);
        rtapi_print_msg(RTAPI_MSG_NONE,"  prev term = %u, type = %u, id = %u, accel_mode = %d\n",
        ...
        if (tc->atspeed) {
            ...
            rtapi_print_msg(RTAPI_MSG_NONE,"Found atspeed at id %d\n",tc->id);
            tc->finalvel = 0.0;
        }

        if (!tc->finalized) {
            rtapi_print_msg(RTAPI_MSG_NONE,"Segment %d, type %d not finalized, continuing\n",tc->id,tc->motion_type);
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"Reached optimization depth limit\n");
    return TP_ERR_OK;
}
...
STATIC int tpSetupTangent(TP_STRUCT const * const tp,
    ...
    if (!tc || !prev_tc) {
        rtapi_print_msg(RTAPI_MSG_NONE,"missing tc or prev tc in tangent check\n");
        return TP_ERR_FAIL;
    }
    //If we have ABCUVW movement, then don't check for tangency
    if (tcRotaryMotionCheck(tc) || tcRotaryMotionCheck(prev_tc)) {
        rtapi_print_msg(RTAPI_MSG_NONE,"found rotary axis motion\n");
        return TP_ERR_FAIL;
    }

    if (emcmotConfig->arcBlendOptDepth < 2) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Optimization depth %d too low for tangent optimization\n",
                        emcmotConfig->arcBlendOptDepth);
        return TP_ERR_FAIL;
    }

    if (prev_tc->term_cond == TC_TERM_COND_STOP) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Found exact stop condition\n");
        return TP_ERR_FAIL;
    }
    ...
    if (res_endtan || res_starttan) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Got %d and %d from tangent vector calc\n",
                        res_endtan, res_starttan);
    }

    rtapi_print_msg(RTAPI_MSG_NONE,"prev tangent vector: %f %f %f\n", prev_tan.x, prev_tan.y, prev_tan.z);
    rtapi_print_msg(RTAPI_MSG_NONE,"this tangent vector: %f %f %f\n", this_tan.x, this_tan.y, this_tan.z);
    ...
    {
        rtapi_print_msg(RTAPI_MSG_NONE,"Found sharp corner\n");
        tcSetTermCond(prev_tc, tc, TC_TERM_COND_STOP);
        return TP_ERR_FAIL;
    }
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"tangent v_max = %f\n",v_max);
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"acc_diff: %f %f %f\n",
                    acc_diff.x,
                    acc_diff.y,
                    acc_diff.z);
    rtapi_print_msg(RTAPI_MSG_NONE,"acc_scale: %f %f %f\n",
                    acc_scale.x,
                    acc_scale.y,
                    acc_scale.z);
    ...
    if (acc_scale_max < kink_ratio) {
        rtapi_print_msg(RTAPI_MSG_NONE," Kink acceleration within %g, using tangent blend\n", kink_ratio);
        tcSetTermCond(prev_tc, tc, TC_TERM_COND_TANGENT);
        ...
        rtapi_print_msg(RTAPI_MSG_NONE,"Kink acceleration scale %f above %f, kink vel = %f, blend arc may be faster\n",
                        acc_scale_max,
                        kink_ratio,
                        prev_tc->kink_vel);
        ...
        TC_STRUCT *blend_tc)
{
    ...
    case BLEND_NONE:
    default:
        rtapi_print_msg(RTAPI_MSG_NONE,"intersection type not recognized, aborting arc\n");
...
STATIC tc_blend_type_t tpHandleBlendArc(TP_STRUCT * const tp, TC_STRUCT * const tc) {
    ...
    if ( !prev_tc) {
        rtapi_print_msg(RTAPI_MSG_NONE," queue empty\n");

        //rtapi_print_msg(RTAPI_MSG_NONE,"addline\n");
        return NO_BLEND;
    }
    if (prev_tc->progress > prev_tc->target / 2.0) {
        rtapi_print_msg(RTAPI_MSG_NONE," prev_tc progress (%f) is too large, aborting blend arc\n", prev_tc->progress);
        return NO_BLEND;
    }
    ...
    case TP_ERR_FAIL:
        rtapi_print_msg(RTAPI_MSG_NONE," tpSetupTangent failed, aborting blend arc\n");
    case TP_ERR_OK:
        return res_tan;
              ...
              char atspeed, int indexer_jnum, struct state_tag_t tag)
{
    ...
    if (tc.target < TP_POS_EPSILON) {
        rtapi_print_msg(RTAPI_MSG_NONE,"failed to create line id %d, zero-length segment\n",tp->nextId);
                ...
                struct state_tag_t tag)
{
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"== AddCircle ==\n");
    rtapi_print_msg(RTAPI_MSG_NONE,"ini_maxvel = %f\n",ini_maxvel);
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"tc.target = %f\n",tc.target);
    tc.nominal_length = tc.target;
                                 ...
                                 double * const acc, double * const vel_desired)
{
    ...
    if (tc_finalvel > 0.0 && tc->term_cond != TC_TERM_COND_TANGENT) {
        rtapi_print_msg(RTAPI_MSG_NONE, "Final velocity of %f with non-tangent segment!\n",tc_finalvel);
        tc_finalvel = 0.0;
    }
#endif
                                ...
                                double * const vel_desired)
{
    ...
    if (vel_final < TP_VEL_EPSILON) {
        rtapi_print_msg(RTAPI_MSG_NONE," vel_final %f too low for velocity ramping\n", vel_final);
        return TP_ERR_FAIL;
    }
...
STATIC void tpUpdateRigidTapState(TP_STRUCT const * const tp,
    ...
    case REVERSING:
        ...
        if (new_spindlepos < old_spindlepos) {
            ...
            rtapi_print_msg(RTAPI_MSG_NONE, "old target = %f", tc->target);
            tc->coords.rigidtap.reversal_target = aux->tmag;
            tc->target = aux->tmag + 10. * tc->uu_per_rev;
            tc->progress = 0.0;
            rtapi_print_msg(RTAPI_MSG_NONE, "new target = %f", tc->target);
...
STATIC int tpUpdateMovementStatus(TP_STRUCT * const tp, TC_STRUCT const * const tc ) {
    ...
    tc_id->Pin=tc->id;
    tc_motiontype->Pin=tc->motion_type;
    tc_canon_motiontype->Pin=tc->canon_motion_type;

    tp->motionType = tc->canon_motion_type;

    tp->activeDepth = tc->active_depth;
    tc_current_depth->Pin=tc->active_depth;

    emcmotStatus->distance_to_go = tc->target - tc->progress;

    //tc_progress->Pin=tc->progress;
    tc_target->Pin=tc->target;
    dtg->Pin=tc->target - tc->progress;

    emcmotStatus->enables_queued = tc->enables;
    // report our line number to the guis
    tp->execId = tc->id;
    tp_exec_id->Pin=tp->execId;
...
STATIC int tpCompleteSegment(TP_STRUCT * const tp,
    ...
    if (tp->reverse_run) {
        ...
        rtapi_print_msg(RTAPI_MSG_NONE,"Finished reverse run of tc id %d\n", tc->id);
    } else {
        int res_pop = tcqPop(&tp->queue);
        if (res_pop) rtapi_print_msg(RTAPI_MSG_NONE,"Got error %d from tcqPop!\n", res_pop);
        rtapi_print_msg(RTAPI_MSG_NONE,"Finished tc id %d\n", tc->id);
    }
...
STATIC tp_err_t tpCheckAtSpeed(TP_STRUCT * const tp, TC_STRUCT * const tc)
{
    ...
    if (MOTION_ID_VALID(tp->spindle.waiting_for_index)) {
        if (emcmotStatus->spindle_status[tp->spindle.spindle_num].spindle_index_enable) {
            ...
            rtapi_print_msg(RTAPI_MSG_NONE, "Index seen on spindle %d\n", tp->spindle.spindle_num);
...
STATIC tp_err_t tpActivateSegment(TP_STRUCT * const tp, TC_STRUCT * const tc) {
    ...
    if (segment_time < cutoff_time &&
            ...
            length != 0)
    {
        rtapi_print_msg(RTAPI_MSG_NONE,"segment_time = %f, cutoff_time = %f, ramping\n",
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"Activate tc id = %d target_vel = %f req_vel = %f final_vel = %f length = %f\n",
                    tc->id,
                    tc->target_vel,
                    tc->reqvel,
                    tc->finalvel,
    ...
    if (TC_SYNC_POSITION == tc->synchronized && !(emcmotStatus->spindleSync)) {
        rtapi_print_msg(RTAPI_MSG_NONE,"Setting up position sync\n");
        ...
        tp->spindle.offset = 0.0;
        rtapi_print_msg(RTAPI_MSG_NONE, "Waiting on sync. spindle_num %d..\n", tp->spindle.spindle_num);
        return TP_ERR_WAITING;
    }
...
STATIC void tpSyncPositionMode(TP_STRUCT * const tp, TC_STRUCT * const tc,
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"Spindle at %f\n",spindle_pos);
    ...
    if(tc->sync_accel) {
        ...
        if(tc->currentvel >= target_vel) {
            ...
            tc->target_vel = tc->maxvel;
            tc_target_vel->Pin=tc->target_vel;
        }
    } else {
...
STATIC int tpUpdateCycle(TP_STRUCT * const tp,
    ...
    // tc->progress always from 0 to segment lenght, and always positve.
    ...
    if(run==1){
        ...
        if(!trigger){
            ...
            //rtapi_print_msg(RTAPI_MSG_NONE,"pvec size: %zu \n",size);
            ttot=to_ttot_pvec(pvec,size);
            stot=to_stot_pvec(pvec,size);
            //rtapi_print_msg(RTAPI_MSG_NONE,"ttot: %f \n",ttot);
            //rtapi_print_msg(RTAPI_MSG_NONE,"stot: %f \n",stot);
        ...
        sc_pvec_size->Pin=size;


        if(size>0 && at_time<ttot){
            s_old=s_new;

            struct sc_vsa vsa;
            interpolate_periods(at_time,pvec,size,&vsa,&finished);
            //rtapi_print_msg(RTAPI_MSG_NONE,"si: %f \n",vsa.s);
            vi->Pin=vsa.v;
            si->Pin=vsa.s;
            ai->Pin=vsa.a;
            s_new=vsa.s;
    ...
    //! If close, finish. Or if scurve vec is empty.
    if(netto_difference_of_2_values(tc->progress,tc->target)<0.1){
...
STATIC inline int tcSetSplitCycle(TC_STRUCT * const tc, double split_time,
                                  double v_f)
{
    rtapi_print_msg(RTAPI_MSG_NONE,"split time for id %d is %.16g\n", tc->id, split_time);
    if (tc->splitting != 0 && split_time > 0.0) {
        rtapi_print_msg(RTAPI_MSG_NONE,"already splitting on id %d with cycle time %.16g, dx = %.16g, split time %.12g\n",
                        tc->id,
                        tc->cycle_time,
...
STATIC int tpCheckEndCondition(TP_STRUCT const * const tp, TC_STRUCT * const tc, TC_STRUCT const * const nexttc) {
    ...
    if (dx <= TP_POS_EPSILON) {
        ...
        // rtapi_print_msg(RTAPI_MSG_NONE,"close to target, dx = %.12f\n",dx);
                              ...
                              TC_STRUCT * const nexttc)
{
    ...
    rtapi_print_msg(RTAPI_MSG_NONE,"tc id %d splitting\n",tc->id);
    ...
    if (!nexttc) {
        rtapi_print_msg(RTAPI_MSG_NONE,"no nexttc in split cycle\n");
        return TP_ERR_OK;
    }
    ...
    case TC_TERM_COND_TANGENT:
        ...
        //rtapi_print_msg(RTAPI_MSG_NONE,"Doing tangent split\n");
        break;
    case TC_TERM_COND_PARABOLIC:
        break;
    case TC_TERM_COND_STOP:
    ...
    case TC_TERM_COND_EXACT:
        break;
    default:
        rtapi_print_msg(RTAPI_MSG_NONE,"unknown term cond %d in segment %d\n",
                        tc->term_cond,
                        tc->id);
    }
...
int tpRunCycle(TP_STRUCT * const tp, long period)
{
    ...
    case TC_SYNC_VELOCITY:
        rtapi_print_msg(RTAPI_MSG_NONE,"sync velocity\n");
        tpSyncVelocityMode(tp, tc, nexttc);
        break;
    case TC_SYNC_POSITION:
        rtapi_print_msg(RTAPI_MSG_NONE,"sync position\n");
        tpSyncPositionMode(tp, tc, nexttc);
        break;
    default:
        rtapi_print_msg(RTAPI_MSG_NONE,"unrecognized spindle sync state!\n");
        break;
    }
    ...
    if(tc_remove->Pin){
        rtapi_print_msg(RTAPI_MSG_NONE,"new gcode line\n");
        tc->remove=1;
        tc_remove->Pin=0;
...
int tpSetRunDir(TP_STRUCT * const tp, tc_direction_t dir)
{
    ...
    case TC_DIR_REVERSE:
        ...
        return TP_ERR_OK;
    default:
        rtapi_print_msg(RTAPI_MSG_NONE,"Invalid direction flag in SetRunDir");
        return TP_ERR_FAIL;
    }
}
